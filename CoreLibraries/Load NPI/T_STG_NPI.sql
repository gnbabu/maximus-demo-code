...
/****** Object:  Table [dbo].[T_STG_NPI]    Script Date: 07/19/2012 19:32:13 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[T_STG_NPI]') AND type in (N'U'))
DROP TABLE [dbo].[T_STG_NPI]
GO
