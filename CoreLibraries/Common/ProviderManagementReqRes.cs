...
{
    public class ProviderManagementReqRes
    {
        ...
        public ProviderManagementReqRes()
        {
        ...
        public string providerManagementEnrollRequest(int transactionID, bool makeRequest = false)
        {
            ...
            try
            {
                ...
                ProviderManagementReference.EnrollRequestPayload enrollRequestPayload = new ProviderManagementReference.EnrollRequestPayload();
                enrollRequestPayload.ProviderInformation = new ProviderManagementReference.EnrollProviderInformation
                {
                ...
                ProviderManagementReference.InqMessageHeaderSubscriber[] imq = new ProviderManagementReference.InqMessageHeaderSubscriber[1];
                imq[0] = ProviderManagementReference.InqMessageHeaderSubscriber.ALL;
                ProviderManagementReference.MessageHeader msgHeader = new ProviderManagementReference.MessageHeader();
                msgHeader.BusinessFlow = "EnrollProvider";
                msgHeader.StateCode = "OH";
                msgHeader.RequestorSystem = ProviderManagementReference.InqMessageHeaderRequestorSystem.PNM;
                ...
                ProviderManagementReference.enrollProviderRequest epiPM = new ProviderManagementReference.enrollProviderRequest();
                epiPM.MessageHeader = msgHeader;
                epiPM.Payload = enrollRequestPayload;

                System.Xml.Serialization.XmlSerializer x = new System.Xml.Serialization.XmlSerializer(typeof(ProviderManagementReference.enrollProviderRequest));
        ...
        public string providerManagementUpdateRequest(int transactionID, bool makeRequest = false)
        {
            ...
            try
            {
                ...
                ProviderManagementReference.UpdateRequestPayload updateRequestPayload = new ProviderManagementReference.UpdateRequestPayload();
                updateRequestPayload.ProviderInformation = new ProviderManagementReference.UpdateProviderInformation
                {
                ...
                ProviderManagementReference.updateProviderRequest epiPM = new ProviderManagementReference.updateProviderRequest();
                epiPM.MessageHeader = msgHeader;
                epiPM.Payload = updateRequestPayload;

                System.Xml.Serialization.XmlSerializer x = new System.Xml.Serialization.XmlSerializer(typeof(ProviderManagementReference.updateProviderRequest));
                var emptyNs = new XmlSerializerNamespaces(new[] { XmlQualifiedName.Empty });
                var settings = new XmlWriterSettings();
                settings.Indent = true;
                settings.OmitXmlDeclaration = true;
