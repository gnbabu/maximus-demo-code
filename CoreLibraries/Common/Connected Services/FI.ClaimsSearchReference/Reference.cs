...
namespace Corp.Core.Libraries.FI.ClaimsSearchReference {
    ...
    public interface ClaimsSearchService {
        ...
        Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsResponse SearchClaims(Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://service.operationmgmt.fi/ClaimsService/SearchClaims", ReplyAction="*")]
        System.Threading.Tasks.Task<Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsResponse> SearchClaimsAsync(Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsRequest request);
    }
    ...
    public partial class SearchClaimsRequest {
        ...
        public Corp.Core.Libraries.FI.ClaimsSearchReference.MessageHeaderType MessageHeader;
        
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.operationmgmt.fi/ClaimsService/search", Order=1)]
        public Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsRequestPayloadType RequestPayload;
        
        public SearchClaimsRequest() {
        }
        
        public SearchClaimsRequest(Corp.Core.Libraries.FI.ClaimsSearchReference.MessageHeaderType MessageHeader, Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsRequestPayloadType RequestPayload) {
    ...
    public partial class SearchClaimsResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.operationmgmt.fi/ClaimsService/search", Order=0)]
        public Corp.Core.Libraries.FI.ClaimsSearchReference.ResponseHeaderType ResponseHeader;
        
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.operationmgmt.fi/ClaimsService/search", Order=1)]
        [System.Xml.Serialization.XmlElementAttribute("ClaimHeaderResponse")]
        public Corp.Core.Libraries.FI.ClaimsSearchReference.ClaimHeaderResponseType[] ClaimHeaderResponse;
        ...
        public Corp.Core.Libraries.FI.ClaimsSearchReference.ErrorDetailsType[] Errors;
        
        public SearchClaimsResponse() {
        }
        
        public SearchClaimsResponse(Corp.Core.Libraries.FI.ClaimsSearchReference.ResponseHeaderType ResponseHeader, Corp.Core.Libraries.FI.ClaimsSearchReference.ClaimHeaderResponseType[] ClaimHeaderResponse, string Offset, string TotalRecords, Corp.Core.Libraries.FI.ClaimsSearchReference.ErrorDetailsType[] Errors) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ClaimsSearchServiceChannel : Corp.Core.Libraries.FI.ClaimsSearchReference.ClaimsSearchService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ClaimsSearchServiceClient : System.ServiceModel.ClientBase<Corp.Core.Libraries.FI.ClaimsSearchReference.ClaimsSearchService>, Corp.Core.Libraries.FI.ClaimsSearchReference.ClaimsSearchService {
        ...
        Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsResponse Corp.Core.Libraries.FI.ClaimsSearchReference.ClaimsSearchService.SearchClaims(Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsRequest request) {
            return base.Channel.SearchClaims(request);
        }
        
        public Corp.Core.Libraries.FI.ClaimsSearchReference.ResponseHeaderType SearchClaims(Corp.Core.Libraries.FI.ClaimsSearchReference.MessageHeaderType MessageHeader, Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsRequestPayloadType RequestPayload, out Corp.Core.Libraries.FI.ClaimsSearchReference.ClaimHeaderResponseType[] ClaimHeaderResponse, out string Offset, out string TotalRecords, out Corp.Core.Libraries.FI.ClaimsSearchReference.ErrorDetailsType[] Errors) {
            Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsRequest inValue = new Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsRequest();
            inValue.MessageHeader = MessageHeader;
            inValue.RequestPayload = RequestPayload;
            Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsResponse retVal = ((Corp.Core.Libraries.FI.ClaimsSearchReference.ClaimsSearchService)(this)).SearchClaims(inValue);
        ...
        public System.Threading.Tasks.Task<Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsResponse> SearchClaimsAsync(Corp.Core.Libraries.FI.ClaimsSearchReference.SearchClaimsRequest request) {
