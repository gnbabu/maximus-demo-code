...
namespace MAXIMUS.Core.Libraries
{
    ...
    ///     Date:           2012.02.29
    ///     Name:           PgpEncrypt
    ///     Description:    Provides the ability to encrypt a PGP encrypted file
    ...
    public class PgpEncrypt
    {
        ...
        /// <param name="unencryptedFileInfo">The FileInfo object associated with the file to be encrypted</param>
