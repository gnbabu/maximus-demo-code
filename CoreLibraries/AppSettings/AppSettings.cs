...
namespace MAXIMUS.Core.Libraries
{
    ...
    public class AppSettings
    {
        ...
        {
            string value = value = GetValue(key, defaultValue);
            return value;
        }
        ...
        {
            string value = GetValue(key, defaultValue, connectionStringName);
            return value;
        }
        ...
        public static string GetConnectionString(string connectionStringName)
        {
            try
            {
                ...
                string connName = string.IsNullOrEmpty(connectionStringName) ? "mainDB" : connectionStringName;

                var connData = ConfigurationManager.ConnectionStrings[connName];
                if (connData != null)
                {
                    connString = connData.ConnectionString;
                ...
                // attempt to get connection string
                ConnectionStringSettings connectString = appConfig.ConnectionStrings.ConnectionStrings[connName];
                ...
                {
                    connString  = connectString.ConnectionString;
                }
                return connString;
            }
            catch (Exception ex)
