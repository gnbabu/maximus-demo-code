SELECT DISTINCT en.[P-SYS-ID]
 ...
 WHERE en.[P-ENROL-STAT-TY-CD] = '00' AND addr.[P-ADR-TY-CD] = 'L' AND prv.[P-REC-TY-CD] = 'P' AND en.[P-STAT-END-DT] IS NOT NULL AND
 CASE WHEN ISDATE(en.[P-STAT-END-DT]) = 1 THEN CAST(en.[P-STAT-END-DT] AS datetime) ELSE '1/1/1753' END > '12/31/2015'  AND 
  ...
  WHERE en1.[P-ENROL-STAT-TY-CD] = '00' AND prv1.[P-REC-TY-CD] = 'P' AND en1.[P-STAT-END-DT] IS NOT NULL AND
  CASE WHEN ISDATE(en1.[P-STAT-END-DT]) = 1 THEN CAST(en1.[P-STAT-END-DT] AS datetime) ELSE '1/1/1753' END > '12/31/2015' AND 
