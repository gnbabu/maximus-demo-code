/****** Object:  StoredProcedure [dbo].[DCConv_Validate_Step1]    Script Date: 8/1/2016 3:13:13 PM ******/
IF object_id('[dbo].[DCConv_Validate_Step1]','P') is not null
DROP PROCEDURE [dbo].DCConv_Validate_Step1
GO
/****** Object:  StoredProcedure [dbo].[DCConv_Validate_Step1]    Script Date: 8/1/2016 3:13:13 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	-- Augment the lookup table LKUP_PROVIDER_SPECIALTY_CODE
	SET @Query = 'IF NOT EXISTS (SELECT [P-SPECL-CD] FROM [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] WHERE [P-SPECL-CD] = ''800'') ';
	SET @Query = @Query + 'INSERT INTO [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] ([P-SPECL-CD], [Short], [Long], [Mnemonic]) VALUES (''800'',''FQHCBhvHth'',''FQHC Behavioral Health'',''FQHC-BEHAV-HEALTH'')';
	EXEC (@Query);

	SET @Query = 'IF NOT EXISTS (SELECT [P-SPECL-CD] FROM [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] WHERE [P-SPECL-CD] = ''801'') ';
	SET @Query = @Query + 'INSERT INTO [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] ([P-SPECL-CD], [Short], [Long], [Mnemonic]) VALUES (''801'',''FQHCPrCare'',''FQHC Primary Care'',''FQHC-PRIMARY-CARE'')';
	EXEC (@Query);

	SET @Query = 'IF NOT EXISTS (SELECT [P-SPECL-CD] FROM [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] WHERE [P-SPECL-CD] = ''802'') ';
	SET @Query = @Query + 'INSERT INTO [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] ([P-SPECL-CD], [Short], [Long], [Mnemonic]) VALUES (''802'',''FQHCDental'',''FQHC Dental'',''FQHC-DENTAL'')';
	EXEC (@Query);
	
	SET @Query = 'IF NOT EXISTS (SELECT [P-SPECL-CD] FROM [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] WHERE [P-SPECL-CD] = ''803'') ';
	SET @Query = @Query + 'INSERT INTO [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] ([P-SPECL-CD], [Short], [Long], [Mnemonic]) VALUES (''803'',''CompanSvcs'',''Companion Services'',''COMPANION-SVCS'')';
	EXEC (@Query);

	SET @Query = 'IF NOT EXISTS (SELECT [P-SPECL-CD] FROM [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] WHERE [P-SPECL-CD] = ''804'') ';
	SET @Query = @Query + 'INSERT INTO [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] ([P-SPECL-CD], [Short], [Long], [Mnemonic]) VALUES (''804'',''EPDPhyThpy'',''EPD Physical Therapy'',''EPD-PHYS-THERAPY'')';
	EXEC (@Query);

	SET @Query = 'IF NOT EXISTS (SELECT [P-SPECL-CD] FROM [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] WHERE [P-SPECL-CD] = ''805'') ';
	SET @Query = @Query + 'INSERT INTO [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] ([P-SPECL-CD], [Short], [Long], [Mnemonic]) VALUES (''805'',''EPDOccThpy'',''EPD Occupational Therapy'',''EPD-OCCUP-THERAPY'')';
	EXEC (@Query);

	SET @Query = 'IF NOT EXISTS (SELECT [P-SPECL-CD] FROM [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] WHERE [P-SPECL-CD] = ''806'') ';
	SET @Query = @Query + 'INSERT INTO [' + @pin_src_database_name + '].[dbo].[LKUP_PROVIDER_SPECIALTY_CODE] ([P-SPECL-CD], [Short], [Long], [Mnemonic]) VALUES (''806'',''EPDAdDyPgm'',''EPD Adult Day Health Program'',''EPD-ADLT-DAY-HLTH'')';
	EXEC (@Query);
