...
{
    public class WFWaiverSendUpdateToSI : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFWaiverSendUpdateToSI(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                if (canMakeWSRequest.Equals("true"))
                {
                    ...
                    partialSubService = Constants.PartialProviderSubscriberSystems.PSM;
                    ...
                    if (transactionType > 0)
                    {
                        ...
                        // RegistrationController.UpdatePNMApplicationStatus(regID, CON.PSMApplicationStatusID.ACCEPTED, DateTime.Now, new Guid(CON.appAdminUserId));
                        RegistrationController.PopulateStagingData(tqId, partialTTService, "ManualUpdate");
                        ServicePointManager.Expect100Continue = true;
                        ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls | SecurityProtocolType.Tls11 | SecurityProtocolType.Tls12 | SecurityProtocolType.Ssl3;

                        txnResult = pprr.partialProviderManagementSubmitRequest(tqId, partialSubService, true, false);
