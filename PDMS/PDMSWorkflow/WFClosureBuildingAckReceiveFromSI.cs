...
{
    public class WFClosureBuildingAckReceiveFromSI: BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFClosureBuildingAckReceiveFromSI(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                if (canMakeWSRequest.Equals("true"))
                {
                    ...
                    sqlParms.Add(SqlParms.CreateParameter("RegID", DbType.Int32, BuildingRegId, false));
                    ...
                    sqlParmsTR.Add(SqlParms.CreateParameter("REG_ID", DbType.Int32, BuildingRegId, false));
