...
{
    public class WFSendPayloadDODD : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFSendPayloadDODD(int processID, int stepID)
            ...
            try
            {
                ...
                if (canMakeWSRequest.Equals("true"))
                {
                    ...
                    if (transactionType > 0)
                    {
                        ...
                        RegistrationController.PopulateStagingData(tqId, partialTTService, manualUpdate);   //Application Type is sent as Manual Update in the Payload
