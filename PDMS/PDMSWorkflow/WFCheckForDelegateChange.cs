...
{
    public class WFCheckForDelegateChange : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFCheckForDelegateChange(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                {
                    if (!RegistrationController.HasDelegateChanged(regID))
                    {
                        nextStep = "No Change";
                        toReturn = true;
                    }
