...
{
    public class WFLTCUpdateDODDContract : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFLTCUpdateDODDContract(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string ddContractNumber = ObjectControllerHelper.GetString("dd_contract_number", drReg);
                    ...
                    if (!string.IsNullOrEmpty(ddContractNumber))
                    {
                        //nextStep = (workflowEventTypeID == CON.WorkflowEventType.UpdateReg && WaiverServiceUpdateTypeID == CON.WaiverServiceUpdateType.DODD) ? "Check Waiver Queue" : "Next";                                
                        if (workflowEventTypeID == CON.WorkflowEventType.UpdateReg && WaiverServiceUpdateTypeID == CON.WaiverServiceUpdateType.DODD)
