...
{
    public class WFSendToDODD : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFSendToDODD(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                {                    
                    ...
                    if (appEnv.Equals(CON.Environment.E2E) || appEnv.Equals(CON.Environment.INT02) || appEnv.Equals(CON.Environment.OH_UAT))
                    {
                        ...
                        if (transactionType > 0)
                        {
                           int tqId = TransactionController.InsertTransactionQueue(
                            ...
                            if (isPubSub)
                            {
                                RegistrationController.PopulateStagingData(tqId, payloadType, CON.ManualUpdate);
