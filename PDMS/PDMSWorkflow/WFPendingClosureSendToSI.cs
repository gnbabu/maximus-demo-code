...
{
    public class WFPendingClosureSendToSI : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFPendingClosureSendToSI(int processID, int stepID)
            ...
            try
            {
                ...
                if (canMakeWSRequest.Equals("true"))
                {
                    ...
                    if (transactionType > 0)
                    {
                        ...
                        RegistrationController.UpdateLTCRiskAlertCustom(regID, ProcessID);
