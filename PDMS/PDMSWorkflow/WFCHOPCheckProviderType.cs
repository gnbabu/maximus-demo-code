...
{
    public class WFCHOPCheckProviderType : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFCHOPCheckProviderType(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                if (mmisProviderTypeID.Equals(CON.LTCProviderTypes.NONSTATE_OPERATED_ICF_MR))
                {
                    nextStep = "Yes";                    
                }
                else
