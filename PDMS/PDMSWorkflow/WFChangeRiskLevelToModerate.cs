...
{
    public class WFChangeRiskLevelToModerate : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFChangeRiskLevelToModerate(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                int riskLevelStatus = 0;
                if (drReg != null)
                {
                    riskLevelStatus = ObjectControllerHelper.GetInt("RISK_LEVEL_STATUS_ID", drReg);
                }
                
                // 1 == increased
                if (riskLevelStatus != 1)
                {
                    ...
                    DataAccess.ExecuteStoredProcedure("usp_ChangeProviderRiskLevel", parameters);
                }
