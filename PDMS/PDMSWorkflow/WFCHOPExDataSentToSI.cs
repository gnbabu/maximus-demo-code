...
{
    public class WFCHOPExDataSentToSI : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFCHOPExDataSentToSI(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                //OHPNM-19466 Send transaction only if exiting is termed in the risk alert wf.
                ...
                {
                    if(enrollmentStatusCode == CON.EnrollmentStatusTypeID.InActive.ToString() && !ObjectControllerHelper.IsDateNull(termDate))
                    {
