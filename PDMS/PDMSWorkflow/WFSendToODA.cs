...
{
    public class WFSendToODA : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFSendToODA(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                {
                    string appEnv = AppSettings.Get("Environment");
                    if (appEnv.Equals(CON.Environment.E2E) || appEnv.Equals(CON.Environment.OH_UAT) || appEnv.Equals(CON.Environment.INT02))
                    {
