...
{
    public class WFSendReconsiderationTransactionToDODD : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFSendReconsiderationTransactionToDODD(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                if (ApplicationTypeID == CON.ApplicationType.Waiver && (WaiverTypeID == CON.WaiverApplicationTypeID.DODD || WaiverTypeID == CON.WaiverApplicationTypeID.NonMedicaidDODD)) {
                    ...
                    if (canMakeWSRequest.Equals("true"))
                    {
                        ...
                        if (transactionType > 0)
                        {
                            ...
                            RegistrationController.PopulateStagingData(tqId, CON.TransactionTypeValues.PSM_FULL, "ManualUpdate");
