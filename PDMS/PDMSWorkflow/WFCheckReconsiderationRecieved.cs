...
{
    class WFCheckReconsiderationRecieved : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFCheckReconsiderationRecieved(int processID, int stepID)
