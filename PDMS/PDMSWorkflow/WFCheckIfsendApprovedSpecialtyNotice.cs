...
{
    public class WFCheckIfsendApprovedSpecialtyNotice : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFCheckIfsendApprovedSpecialtyNotice(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                {
                    // Send Approved Specialty Notice Email
                    if (RegistrationController.HasSpecialtyChange(regID))
                    {
                        nextStep = "Yes";
                    }
                    else
                    {
                        //No email go to Update Provider Review complete
                        nextStep = "No";
                    }
                }
                else
