...
{
    public class WFCheckLTCProviderType : BaseWorkflowTask, IWorkflowTask
    {
        string nextStep = null;

        public WFCheckLTCProviderType(int processID, int stepID)
        ...
        override public bool ProcessTask()
        {
            ...
            try
            {
                ...
                if (mmisProviderTypeID.Equals(CON.LTCProviderTypes.NONSTATE_OPERATED_ICF_MR) || mmisProviderTypeID.Equals(CON.LTCProviderTypes.STATE_OPERATED_ICF_MR))
                {
                    nextStep = "Yes";
                }
                else
