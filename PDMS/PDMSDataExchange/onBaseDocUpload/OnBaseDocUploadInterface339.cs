...
{
    public class OnBaseDocUploadInterface339 : BaseJob, IJob
    {

        private int logCnt = 0;
        private Logging log = null;

        public OnBaseDocUploadInterface339(Guid threadId)
            : base(threadId)
        {
            this.ThreadId = threadId;
        }

        private readonly string appID = "4B6684F7-6253-40D6-B753-2C91BC076B3E";
