...
{
    internal class OnBaseDocUploadInterface339_2 : BaseJob, IJob
    {

        private int logCnt = 0;
        private Logging log = null;

        public OnBaseDocUploadInterface339_2(Guid threadId)
            : base(threadId)
        {
            this.ThreadId = threadId;
        }

        private readonly string appID = "5BF2229F-03BB-4243-8BFE-1B73079658B2";
