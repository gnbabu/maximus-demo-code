...
{
    public class PartialProviderManagmentFacade
    {
        ...
        public PartialProviderManagmentFacade()
        {
        ...
        public string partialProviderManagementSubmitRequest(int transactionID, string sendTo, bool makeRequest = false, bool? ReqRes = true)
        {
            ...
            try
            {
                ...
                Corp.Core.Libraries.PartialProviderManagementReference.InqMessageHeaderSubscriber[] subscriberSystem = sendToSubscriberService(sendTo);
