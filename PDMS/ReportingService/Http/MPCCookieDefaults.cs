namespace ReportingService.Services.Http
{
    /// <summary>
    /// Represents default values related to cookies
    /// </summary>
    public static partial class MPCCookieDefaults
    {
        /// <summary>
        /// Gets the cookie name prefix
        /// </summary>
        public static string Prefix => ".MPC";

        public static string ImpersonatedRoleCookie => ".ImpersonatedRole";
        ...
        /// Gets a cookie name of the authentication
        /// </summary>
        public static int CookieExpireInMinutes => 15;
        ...
        public static string reportingAuthToken => ".rptAuthToken";
    }
}