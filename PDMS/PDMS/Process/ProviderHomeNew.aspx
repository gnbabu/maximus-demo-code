<%@ Page Language="C#" AutoEventWireup="true" Inherits="Process_ProviderHomeNew" MasterPageFile="~/MasterPage.master" Title="Provider Management Home" Codebehind="ProviderHomeNew.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        //function ClosePopUp() {
        //    var modal = document.getElementById("mpeProviderAdminSelect");
    ...
    <asp:UpdatePanel ID="upMain" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div id="divAdminProviders" runat="server" style="height: auto; min-height: 100px;">
                <div class="group-hdg">
                    <table style="width: 100%;" role="presentation">
                        <tr>
                            <td class="provider-home-btn" style="text-align: left;"><%--<span class="pageHeader2">My Providers</span>--%>
                                <asp:Button ID="btnMyProviders" runat="server" CssClass="buttonBoxFocus provider-btn-margin" style="font-size: 16px !important;" Text="My Providers" ToolTip="My Providers" OnClick="btnMyProviders_Click" Visible="false" />
                                <asp:Button ID="btnPowerAgentMgmt" runat="server" CssClass="buttonBoxFocus provider-btn-margin" style="font-size: 16px !important;" Text="Power Agent Access Mgmt" ToolTip="Power Agent Access Mgmt" OnClick="btnPowerAgentMgmt_Click" Visible="false" />
                                <div id="divHideSelectProvider" runat="server" style="display: none; visibility: hidden">
                                    ...
                                    <asp:Button ID="btnSelectProviders" runat="server" CssClass="buttonBoxFocus provider-btn-margin" style="font-size: 16px !important;" Text="Select Provider" ToolTip="Select Provider" Enabled="false" OnClick="btnSelectProvidersVoid_Click" Visible="false" />
                                </div>
                                ...
                                <asp:Button ID="btnPendingAgents" runat="server" CssClass="buttonBoxFocus provider-btn-margin" style="font-size: 16px !important;" Text="Pending Agent Requests" ToolTip="Pending Agent Requests" OnClick="btnPendingAgents_Click" Visible="false" />
                                 </div>
                                <asp:Button ID="btnAccountAdmin" runat="server" CssClass="buttonBoxFocus provider-btn-margin" style="font-size: 16px !important;" Text="Account Administration" ToolTip="Account Administration" OnClick="btnAccountAdmin_Click" Visible ="false" />
                                <asp:Button ID="btnAffiliateUpdate" runat="server" CssClass="buttonBoxFocus provider-btn-margin" style="font-size: 16px !important;" Text="Affiliate Update" ToolTip="Affiliate Update" OnClick="btnAffiliateUpdate_Click" Visible ="false"  />
                                <asp:Button ID="btnDDAcountAdmin" runat="server" CssClass="buttonBoxFocus provider-btn-margin" style="font-size: 16px !important;" Text="DD Account Administration" ToolTip="DD Account Administration" OnClick="btnDDAcountAdmin_Click" Visible ="false" />
                                <asp:Button ID="btnAgentBulkUpload" runat="server" CssClass="buttonBoxFocus provider-btn-margin" style="font-size: 16px !important;" Text="Agent Bulk Upload" ToolTip="Agent Roster Upload" OnClick="btnAgentBulkUpload_Click" Visible ="false" />
                                <asp:Button ID="btnInternalApplication" runat="server" CssClass="buttonBoxFocus provider-btn-margin" style="font-size: 16px !important;" Text="Internal Application" ToolTip="Internal Application" OnClick="btnInternalApplication_Click" Visible="false" />
                                <%--<span id="Span1" runat="server" class="formLabelAuto">Now displaying for Administrator 76944213-AK Proadmin</span>--%>
                                <asp:Button ID="btnSwitchAdmin" runat="server" CssClass="buttonBoxFocus provider-btn-margin" style="font-size: 16px !important;" Text="Switch Administrator" ToolTip="Select a different Provider Administrator" OnClick="btnSwitchAdmin_Click" Visible="false" />
                                ...
                                <%--<asp:Button ID="btnNewProvider" runat="server" CssClass="buttonBoxFocus provider-btn-margin" Text="New Provider ? " ToolTip="New Provider" OnClick="btnNewProvider_Click" />--%>
                                <button type="button" id="btnNewProvider" runat="server" class="buttonBoxFocus" style="font-size: 16px !important;"  onclick="window.location.href='NewProvider.aspx'">New Provider ? </button> 
                                <%--<button type="button" id="btnNewProvider" runat="server" class="buttonBoxFocus" onclick="btnNewProvider_Click">New Provider ? </button> --%>
                            </td>
                        </tr>
                        <tr><td class="col-sm-12 text-right" style="padding-right:0px !important"><button type="button" id="btnNewStreamLinedProvider" runat="server" style="font-size: 16px !important;"  class="buttonBoxFocus" onclick="window.location.href='NewStreamLinedProvider.aspx'">New Streamlined Provider</button>  </td></tr>
                        <tr><td class="col-sm-12 text-right" style="padding-right:0px !important"><button type="button" id="btnInitialAtypicalApp" runat="server" style="font-size: 16px !important;"  class="buttonBoxFocus" onclick="window.location.href='AtypicalProviderEnrollment.aspx'">Enroll as Atypical Provider</button>  </td></tr>
                        <tr id="spnSelectedProvAdmin" runat="server" Visible="false"><td style="text-align:center;font-size:16pt;font-weight:bold;color:red"><br /><span id="spnProvAdminTxt" runat="server"> </span></td></tr>
                    </table>
                </div>
                <br />                
                ...
                <telerik:RadGrid ID="gvMyProviders" role="definition" aria-label="MyProviders" TabIndex="0" runat="server" Width="100%" OnNeedDataSource="gvMyProviders_NeedDataSource" aria-busy="true"  
                    ...
                    <MasterTableView AllowSorting="true" PageSize="10"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn DataField="DD_Contract_num" HeaderText="DD Contract Number" SortExpression="DD_Contract_num" Visible="false">
                                 <ItemTemplate>                                    
                                    <asp:Label Text='<%# Bind("DD_Contract_num") %>' runat="server" ID="Label5" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn DataField="DD_Faciity_num" HeaderText="DD Facility Number" SortExpression="DD_Faciity_num" Visible="false">
                                 <ItemTemplate>                                    
                                    <asp:Label Text='<%# Bind("DD_Faciity_num") %>' runat="server" ID="Label6" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn DataField="PracticeLocationZip" HeaderText="Location" SortExpression="PracticeLocationZip"  Visible="false">
                                 <ItemTemplate>                                    
                            ...
                            <telerik:GridTemplateColumn DataField="SubmitDateTime" HeaderText="Submit Date"  SortExpression="SubmitDateTime" Visible="false">
                                 <ItemTemplate>                                    
            ...
            <br />
            <br />
            <div runat="server" id="divErrPowerAgent" visible="false">
                 <table style="width: 100%;" role="presentation">
                     <tr id="Tr1" runat="server"><td style="text-align:center;font-size:16pt;font-weight:bold;color:red"><br /><span>Select an Admin to Proceed by clicking the 'Switch Administrator' Button.</span></td></tr>
                    <tr>
                        <td>
                            <asp:Button ID="Button2" runat="server" CssClass="buttonBoxFocus provider-btn-margin" Text="Switch Administrator" ToolTip="Select a Provider Administrator" OnClick="btnSwitchAdmin_Click" />
                        </td>
                    </tr>
                 </table>
            </div>
            ...
            <%--SAM768--%>
<%--using telerik start--%>
<ajax:ModalPopupExtender ID="mpeProviderAdminSelect" runat="server" PopupControlID="pnlProvAdminSelect" TargetControlID="ButtonDummy" BackgroundCssClass="modalBackground" />
<asp:Panel ID="pnlProvAdminSelect" runat="server" CssClass="modalPopup" Style="display: none; min-height: 250px; height: auto; width: 50%;">
    <asp:Panel ID="pnlHeader" CssClass="popHeader" runat="server" HorizontalAlign="Left">
        <div class="popTitle">
            <asp:Label ID="lblTitle" CssClass="bodyTextBold groupMemberTitle" runat="server" Text="Select Provider Admininstrator" />
        </div>
    </asp:Panel>
    <asp:Panel ID="pnlMain" runat="server" Style="margin-right:10px">
        <div style="text-align: left; padding: 15px; margin-left:10px !important" class="container-fluid">
          <div class="pg-hint4">
              <span>The Power Agent is associated with multiple Provider Administrators. <br />Which Provider Administrator account would you like to manage?</span>
          </div>
        <br />
     <div class="row">
       <div class="col-sm-3">
         <asp:Label ID="lblProviderAdmin" runat="server" Text="Provider Administrator OHID:" CssClass="formLabelAuto" />
       </div>
      <div class="col-sm-9">
          <%--<telerik:RadScriptManager ID="RadScriptManager1" runat="server" />--%>
          <telerik:RadComboBox RenderMode="Lightweight" ID="RadProvAdminddl" runat="server" CheckBoxes="false" AriaSettings-Label="Provider Administrator" EnableAriaSupport="true"
             Width="450" EnableCheckAllItemsCheckBox="false" Skin="PDMSModern" Filter="Contains" MarkFirstMatch="true" EmptyMessage="--Select Provider Administrator--">
         </telerik:RadComboBox>    
          <asp:Label ID="lblErrMsg" runat="server" Text="* Provider Administrator OHID selection is required before proceeding." CssClass="failureNotification" Style="color: Red" Visible="false" />
      </div>
       <br />
       <div class="btnBox" style="margin-right:10%;">
          <asp:Button ID="btnProvAdminOK" runat="server" Text="OK" CssClass="buttonBoxFocus" OnClick="btnProvAdminOK_Click" CausesValidation="true" />
          <asp:Button ID="btnProvAdminCancel" runat="server" Text="Cancel" CssClass="buttonBox" CausesValidation="false" OnClick="btnProvAdminCancel_Click" />
       </div>
      </div>
            </div>
    </asp:Panel>
