<%@ Page Title="Provider Directory" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Process_PublicSearchAPI" Codebehind="PublicSearchAPI.aspx.cs" %>
            ...
            <div id="divPublicSearchG1G2Demo" class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <span class="formLabelSmall" style="color: #545487; font-size: x-large;">Application Programming Interface (API)</span>
                ...
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <span class="formLabelSmall" style="color: #545487; font-size: x-large;">Demo API and Live API</span>
                        <hr style="background-color: #205794; height: 4px; border: none; margin-top: 0;" />
                        <br />
                        <table>
                            <tr>
                ...
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <br />
                        <span class="formLabelSmall" style="color: #545487; font-size: x-large;">API Request Parameters</span>
                        <hr style="background-color: #205794; height: 4px; border: none; margin-top: 0;" />
                ...
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <br />
                        <span class="formLabelSmall" style="color: #545487; font-size: x-large;">Request Parameters</span>
                        <hr style="background-color: #205794; height: 4px; border: none; margin-top: 0;" />
                ...
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <br />
                        <span class="formLabelSmall" style="color: #545487; font-size: x-large;">API Response Parameters</span>
                        <hr style="background-color: #205794; height: 4px; border: none; margin-top: 0;" />
                ...
                <div id="divdemoAPI" class="row">
                    <div class="col-sm-12 text-left">
                        <br />
                        <span class="formLabelSmall" style="color: #545487; font-size: x-large;">Demo API</span>
                        <hr style="background-color: #205794; height: 4px; border: none; margin-top: 0;" />
                        <span class="pg-hint3Center">Use the following form to test generating valid queries. After selecting Submit, the query will display below.</span><br />
                        <br />
                    </div>
                </div>
            </div>
