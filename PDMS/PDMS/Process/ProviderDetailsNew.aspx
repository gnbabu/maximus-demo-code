<%@ Page Language="C#" AutoEventWireup="true" Inherits="Process_ProviderDetailsNew" MasterPageFile="~/MasterPage.master" Title="Provider Management Details" Codebehind="ProviderDetailsNew.aspx.cs" %>
