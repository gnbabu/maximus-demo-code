...
public partial class Process_ProviderCorrespondence : WorkflowPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            var data = new ProviderManagerData() { RegID = Convert.ToInt32(this.WorkflowPage.RegistrationId), MedicaidID = this.WorkflowPage.MedicaidID };
            uc9Correspondence.InitView(data);
        }
    }
}