<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Inherits="Process_HistoryDetails" Codebehind="HistoryDetails.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script>
        ...
        let historyType = urlParams.get("historyType");
        var columns = [];
        var apiURL = "";

        if (historyType == "CredentialingDelegates") {
            columns = [
                { key: 'Operation', title: 'Operation', type: 'text' },
                { key: 'DELEGATES_NAME', title: 'Delegate Name', type: 'text' },
                { key: 'MEDICAID_ID', title: 'Medicaid ID', type: 'text' },
                { key: 'UserName', title: 'User Name', type: 'text' },
                { key: 'DateOfAction', title: 'Update Date', type: 'datetime' }
            ];

            apiURL = "GetCredentalingDelegatesHistoryData";
        }
        if (historyType == "GroupAffiliation") {
            columns = [
                { key: 'Operation', title: 'Operation', type: 'text' },
                { key: 'GroupName', title: 'Group Name', type: 'text' },
                { key: 'NPI', title: 'NPI', type: 'text' },
            ...
            apiURL = "GetGroupAffiliationHistoryData";
        }
        if (historyType == "GroupToIndividual") {
            columns = [
                { key: 'Operation', title: 'Operation', type: 'text' },
                { key: 'PROVIDER_NAME', title: 'Name', type: 'text' },
                { key: 'NPI', title: 'NPI', type: 'text' },
                { key: 'PROVIDER_TYPE_ID', title: 'Provider Type ID', type: 'text' },
                { key: 'PROVIDER_TYPE', title: 'Provider Type', type: 'text' },
                { key: 'SPECIALTY_TYPE_ID', title: 'Specialty Type ID', type: 'text' },
                { key: 'SPECIALTY_TYPE_NAME', title: 'Specialty Type', type: 'text' },
                { key: 'START_DATE', title: 'Start Date', type: 'date' },
                { key: 'END_DATE', title: 'End Date', type: 'date' },
                { key: 'DELEGATE_UPLOAD', title: 'Delegate Upload', type: 'text' },
                { key: 'RENDERING_LOCATION', title: 'Rendering Location', type: 'text' },
                { key: 'AFFILIATION_STATUS', title: 'Status', type: 'text' },
                { key: 'REVALIDATION_DATE', title: 'Revalidation Date', type: 'date' },
                { key: 'MEDICAID_ID', title: 'Medicaid ID', type: 'text' },
                { key: 'IsProviderDirectoryOptout', title: 'Is Directory Opt Out', type: 'text' },
                { key: 'UserName', title: 'User Name', type: 'text' },
                { key: 'DateOfAction', title: 'Update Date', type: 'datetime' }
            ];

            apiURL = "GetGroupToIndividualAffiliationHistoryData";
        }
        if (historyType == "HospitalAffiliation") {
            columns = [
                { key: 'Operation', title: 'Operation', type: 'text' },
            ...
            apiURL = "GetHealthCareAffiliationHistoryData";
        }
        if (historyType == "Medicaid") {
            columns = [
                { key: 'Operation', title: 'Operation', type: 'text' },
                { key: 'ISSUING_STATE', title: 'State', type: 'text' },
                { key: 'MEDICAID_NUMBER', title: 'Medicaid Number', type: 'text' },
                { key: 'EFF_DATE', title: 'Effective Date', type: 'date' },
                { key: 'UserName', title: 'User Name', type: 'text' },
                { key: 'DateOfAction', title: 'Update Date', type: 'datetime' }
            ];

            apiURL = "GetMedicaidHistoryData";
        }
        if (historyType == "Medicare") {
            columns = [
                { key: 'Operation', title: 'Operation', type: 'text' },
                { key: 'MEDICARE_TYPE_NAME', title: 'Type', type: 'text' },
                { key: 'MEDICARE_NUMBER', title: 'Medicare Number', type: 'text' },
                { key: 'MEDICARE_STATE', title: 'State', type: 'text' },
                { key: 'ENROLLMENT_STATUS', title: 'Status', type: 'text' },
                { key: 'MEDICARE_EFF_DATE', title: 'Effective Date', type: 'date' },
                { key: 'MEDICARE_END_DATE', title: 'End Date', type: 'date' },
                { key: 'UserName', title: 'User Name', type: 'text' },
                { key: 'DateOfAction', title: 'Update Date', type: 'datetime' }
            ];

            apiURL = "GetMedicareHistoryData";
        }
        if (historyType == "OrgInfo") {
            columns = [
                { key: 'Operation', title: 'Operation', type: 'text' },
                { key: 'NAME', title: 'Name', type: 'text' },
                { key: 'DBA', title: 'DBA', type: 'text' },
                { key: 'FIRST_NAME', title: 'First Name', type: 'text' },
                { key: 'LAST_NAME', title: 'Last Name', type: 'text' },
                { key: 'TITLE', title: 'Title', type: 'text' },
                { key: 'TAX_ID', title: 'Tax ID', type: 'text' },
                { key: 'NPI', title: 'NPI', type: 'text' },
                { key: 'NPI_START_DATE', title: 'NPI Start', type: 'date' },
                { key: 'NPI_END_DATE', title: 'NPI End', type: 'date' },
                { key: 'GENDER', title: 'Gender', type: 'text' },
                { key: 'BIRTH_DATE', title: 'DOB', type: 'date' },
                { key: 'MMIS_PROVIDER_TYPE_ID', title: 'Provider Type', type: 'text' },
                { key: 'TERM_DATE', title: 'Term Date', type: 'date' },
                { key: 'REVALIDATION_DATE_PRIOR_TO_TERMINATION', title: 'Reval Date', type: 'date' },
                { key: 'CAQH', title: 'CAQH', type: 'text' },
                { key: 'IS_OHIO_RESIDENT', title: 'OH Res', type: 'text' },
                { key: 'UserName', title: 'User Name', type: 'text' },
                { key: 'DateOfAction', title: 'Update Date', type: 'datetime' }
            ];

            apiURL = "GetOrgInfoHistoryData";
        }
        if (historyType == "WorkHistory") {
            columns = [
                { key: 'Operation', title: 'Operation', type: 'text' },
                { key: 'Current_Employer', title: 'Current Employer', type: 'text' },
                { key: 'PRACTICE_NAME', title: 'Practice/Employer Name', type: 'text' },
                { key: 'Worked_From', title: 'Start Date', type: 'date' },
                { key: 'Worked_To', title: 'End Date', type: 'date' },
                { key: 'Organization_Name', title: 'Organization Name', type: 'text' },
                { key: 'ADDRESS1', title: 'Address 1', type: 'text' },
                { key: 'ADDRESS2', title: 'Address 2', type: 'text' },
                { key: 'CITY', title: 'City', type: 'text' },
                { key: 'STATE', title: 'State', type: 'text' },
                { key: 'COUNTY', title: 'County', type: 'text' },
                { key: 'ZIP', title: 'ZIP', type: 'text' },
                { key: 'CONTACT_PHONE_NUMBER', title: 'Phone Number1', type: 'text' },
                { key: 'CONTACT_PHONE_EXT', title: 'Phone Ext1', type: 'text' },
                { key: 'FAX1', title: 'Fax Number1', type: 'text' },
                { key: 'FAX2', title: 'Fax Number2', type: 'text' },
                { key: 'CONTACT_NAME', title: 'Contact Name', type: 'text' },
                { key: 'Contact_Email_Address1', title: 'Email Address1', type: 'text' },
                { key: 'Contact_Email_Address2', title: 'Email Address2', type: 'text' },
                { key: 'ADDITIONAL_INFO', title: 'Additional Information', type: 'text' },
                { key: 'REASON_FOR_DEPARTURE', title: 'Reason for Departure', type: 'text' },
                { key: 'MILTARY_RESERVE', title: 'Are you currently on active miltary duty or miltary reserve?', type: 'text' },
                { key: 'LAST_MODIFIED_USERNAME', title: 'User Name', type: 'text' },
                { key: 'LAST_MODIFIED_DATE_TIME', title: 'Update Date', type: 'datetime' }
            ];

            apiURL = "GetWorkHistoryData";
        }
        if (historyType == "OtherServiceLocations") {
            columns = [
                { key: 'Operation', title: 'Operation', type: 'text' },
                { key: 'ADDRESS1', title: 'Address', type: 'text' },
                { key: 'EMAIL1', title: 'Email', type: 'text' },
                { key: 'PHONE1', title: 'Phone', type: 'text' },
                { key: 'ADR_EFFECTIVE_DATE', title: 'Effective Date', type: 'datetime' },
                { key: 'ADR_END_DATE', title: 'End Date', type: 'datetime' },
                { key: 'UserName', title: 'User Name', type: 'text' },
                { key: 'DateOfAction', title: 'Update Date', type: 'datetime' }
            ];

            apiURL = "GetOtherServcLocationsHistoryData";
        }
        ...
        function fetchDataFromApi() {
            ...
            $.ajax({
                type: "GET",
                url: webApiEnrollment + apiURL + "?regId=" + regId,
                async: false,
                headers: {
            ...
            if (document.getElementById('historyTitle') != null) {
                ...
                if (historyType == "CredentialingDelegates") {
                    document.getElementById('historyTitle').textContent = "Credentialing Delegates History";
                }
                if (historyType == "GroupAffiliation") {
                    document.getElementById('historyTitle').textContent = "Group Affiliation History";
                }
                if (historyType == "GroupToIndividual") {
                    document.getElementById('historyTitle').textContent = "Group Affiliation History";
                }
                if (historyType == "HospitalAffiliation") {
                    document.getElementById('historyTitle').textContent = "Hospital Affiliation History";
                }
                if (historyType == "Medicaid") {
                    document.getElementById('historyTitle').textContent = "Out of State Medicaid History";
                }
                if (historyType == "Medicare") {
                    document.getElementById('historyTitle').textContent = "Medicare History";
                }
                if (historyType == "OrgInfo") {
                    document.getElementById('historyTitle').textContent = "Org Info History";
                }
                if (historyType == "WorkHistory") {
                    document.getElementById('historyTitle').textContent = "Work History History";
                }
            }
            return false;
        }
...
`);
        ...
        function formatValueForSearch(value, col) {
            ...
            // If it's a date column, format as mm/dd/yyyy
            if (col.type === 'date') {
    ...
    <div class="container-fluid" style="min-height: 300px;">
        ...
        <div class="whModalHeader">
            <h3 class="m-0"><strong><span id="historyTitle">Affiliation History</span></strong> </h3>
            ...
            <div class="col-sm-3">
                <div class="form-group whsearch">
                    ...
                    <span class="ohio-tooltip" 
                        ...
                        aria-hidden="true">
                        <asp:Image ID="Image11" Height="13" AlternateText="INFO"  Width="13" runat="server" ImageUrl="~/Images/Infoicon.png" />&nbsp;
                    </span>
