<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Inherits="Process_NewStreamLinedProvider" Codebehind="NewStreamLinedProvider.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageLabelContent" runat="Server">
    ...
    <h2><b>Streamlined Application</b></h2>
</asp:Content>
...
<script type="text/javascript">   
    ...
    function initializeDropdowns() {
        ...
        var APIToken = $("[id*=hdnAccessToken]").val();
         ...
         $.ajax({
             type: "GET",
             url: webApiEnrollment + "GetStreamLinedAppDropdowns",
             headers: {
 ...
 <div class="container-fluid" style="min-height: 300px; font-size: 16pt !important;">
    ...
    <div class="row">
       <div class="col-sm-6 text-center" style="padding: 28px 0 10px 0">
            <button id="btnValidateNPI" type="button" onclick="ValidateNPI()" class="buttonBoxFocus">Validate NPI</button>
        </div>
    </div>
    <div id="divpnlLoader" style="display: none">
        <img src='../Images/loader.gif' style='height: 38px; width: 35px;'>
    </div>
    <div id="divAddressData" style="display:none;">
        <div class="row">
             <div class="col-sm-3 text-right">
                 <label>Taxonomy:</label>
             </div>
             <div class="col-sm-9 text-left">
                 <select id="ddlTaxonomy" class="formDropDownMedium" style="min-width:333px"></select> 
         ...
         <div class="row">
              ...
              <div class="col-sm-9 text-left">
                  <select id="ddlSpecialty" class="formDropDownMedium" style="min-width:333px"></select> 
         ...
         <div class="row">
            ...
            <div class="col-sm-9 text-left">
                <select id="ddlState" class="formDropDownMedium" onchange="PopulateCountyDropdown()" style="min-width:333px"></select>
         ...
         <div class="row">
            ...
            <div class="col-sm-9 text-left">
                <select id="ddlCounty" class="formDropDownMedium" style="min-width:333px"></select>
