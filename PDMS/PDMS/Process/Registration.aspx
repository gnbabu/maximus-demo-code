<%@ Page Title="" Language="C#" MasterPageFile="~/MasterWorkflowPage.master" AutoEventWireup="true" Inherits="Process_Registration" MaintainScrollPositionOnPostback="true" CodeBehind="Registration.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="DivDetails" runat="server">
        <div class="enrollment">
            ...
            <%--<asp:Label id="lblPgTitle" runat="server" CssClass="pageHeader" />--%>
            <uc:registrationnavigation id="ucRegistrationNavigation" runat="server" />
            <asp:Label ID="lblContentRender" runat="server" Text="" />
        ...
        <asp:Panel ID="pnlUploadDocsfull" runat="server">
            ...
            <div class="boxContainer" runat="server" id="dvboxcontainer">
                <asp:Label ID="ucSep1" runat="server" Text="Uploaded Documents" CssClass="boxLabel" Visible="false" />
            </div>
    ...
    <div id="divHelp" runat="server" class="pull-right text-center" style="width: 250px; margin: 10px;">
        <div class="well well-sm" style="background-color: #162e51; color: #fff; border: 1px solid #162e51; border-radius: 4px;">
            <div style="margin-bottom: 10px;">
                <p style="margin: 0; font-size: 13px; opacity: 0.9;">Need Help with</p>
                <strong style="display: block; font-size: 14px;">
                    <span id="spnHelpSection" runat="server"></span>
                </strong>
            </div>
            <asp:Button ID="btnhelp" runat="server"
                Text="View Instructions"
                CssClass="btn btn-sm btn-block" Style="font-weight: 600; color: #000" />
        </div>
    </div>
