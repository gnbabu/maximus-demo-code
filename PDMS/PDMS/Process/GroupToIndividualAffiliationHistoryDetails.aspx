<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Inherits="GroupToIndividualAffiliationHistoryDetails" Codebehind="GroupToIndividualAffiliationHistoryDetails.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script>
        ...
        function fetchDataFromApi() {
            ...
            $.ajax({
                type: "GET",
                url: webApiEnrollment + "GetGroupToIndividualAffiliationHistoryData?regId=" + regId,
                async: false,
                headers: {
