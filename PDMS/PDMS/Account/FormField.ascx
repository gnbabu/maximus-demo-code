<%@ Control Language="C#" AutoEventWireup="true" Inherits="Account_FormField" Codebehind="FormField.ascx.cs" %>
...
<div id="divFieldTextBox" runat="server" style="display:none;">
    <table class="fieldTable">
        <tr>
            ...
            <td>
                <asp:TextBox ID="fieldTextBox" runat="server" CssClass="myFormField myFormField" CausesValidation="true" />
...
<div id="divFieldNumericBox" runat="server" style="display:none;">
    <table class="fieldTable">
        <tr>
            ...
            <td>
                <ew:NumericBox ID="fieldNumericBox" runat="server" CssClass="myFormField myFormField" CausesValidation="true" />
...
<div id="divFieldCalendar" runat="server" style="display:none;">
    <table class="fieldTable">
        <tr>
            ...
            <td>
                <asp:TextBox ID="fieldCalendar" runat="server" CssClass="myFormField myFormField" />
...
<div id="divFieldLabel" runat="server" style="display:none">
    <table class="fieldTable">
        <tr>
            ...
            <td><asp:Label ID="fieldLabel" runat="server" CssClass="formLabel300 myFormField" style="text-align:left" /></td>
        </tr>
    </table>
...
<div id="divFieldStackedLabel" runat="server" style="display:none">
    <table class="fieldTableStacked">
        ...
        <tr>
            <td><asp:Label ID="fieldStackedLabel" runat="server" CssClass="formLabel300 myFormField" style="text-align:left; width:500px;" /></td>
        </tr>
    </table>
...
<div id="divFieldLinkButton" runat="server" style="display:none">
    <table class="fieldTable">
        <tr>
            ...
            <td><asp:LinkButton ID="fieldLinkButton" runat="server" CssClass="formLabel300 myFormField" style="text-align:left" /></td>
        </tr>
    </table>
</div>
...
<div id="divFieldComboBox" runat="server" style="display:none">
    <table class="fieldTable">
        <tr>
            <td><asp:Label AssociatedControlID="fieldComboBox" ID="lblComboBox" runat="server" CssClass="formLabel300" /></td>
            <td><asp:DropDownList ID="fieldComboBox" AutoPostBack="false"  runat="server"  AppendDataBoundItems="true" ></asp:DropDownList></td>
        </tr>
    </table>
</div>
...
<div id="divFieldYesNo" runat="server" style="display:none;">
    <table class="fieldTable">
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="fieldYesNo" runat="server" CssClass="formLabel300 rblYesNo myFormField" TextAlign="Right" RepeatDirection="Horizontal" >
...
<div id="divFieldRadioButtonList" runat="server" style="display:none">
    <table class="fieldTable">
        <tr>
            ...
            <td><asp:RadioButtonList ID="fieldRadioButtonList" runat="server" CssClass="formLabel300 rbl_Vertical myFormField" RepeatDirection="Vertical" TextAlign="Right" /></td>
        </tr>
    </table>
</div>
...
<div id="divFieldCheckBox" runat="server" style="display:none">
    <table class="fieldTable">
        <tr>
            ...
            <td><asp:CheckBox ID="fieldCheckBox" runat="server" CssClass="formLabel300 fieldChk myFormField" /></td>
        </tr>
    </table>
</div>
