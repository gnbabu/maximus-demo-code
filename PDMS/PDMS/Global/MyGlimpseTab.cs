...
/// <summary>
/// Summary description for MyGlimpseTab
/// </summary>
public class MyGlimpseTab : AspNetTab, ITabSetup, ITabLayout, IKey
{
    ...
    {
        get { return "View State Usage"; }
    }

    public string Key
    {
        get { return "glimpse_webforms_ViewStateUsage"; }
    }
