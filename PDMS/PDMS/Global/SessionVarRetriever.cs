...
/// <summary>
/// This class is used as a Session variable "wrapper".
/// Use it to access items in Session.
/// Ideally ALL Session variables could be placed in here to 
/// prevent developers from having to guess what items are in Session, 
/// or to have to use StackTrace.
/// </summary>
/// <created>
///    05/25/2012 MHH
/// </created>
/// <example>
///    Account accntCls = SessionVarRetreiver.Account
/// </example>
/// 
public class SessionVarRetriever
{
        ...
        switch (opt)
        {
            case 1:
                if (!string.IsNullOrEmpty(DashBoardPartyIds) || !string.IsNullOrEmpty(DashBoardSubmitRosterIds) ||
                    SessionVarRetriever.DashBoardTableId > 0) return true;
                break;
            case 2:
                if (!string.IsNullOrEmpty(DashBoardErrorIds) || SessionVarRetriever.DashBoardTableId > 0) return true;
                break;
            case 3:
    ...
    public static string APIToken
    {
        get
        {
            if (Session["APIToken"] == null) Session["APIToken"] = string.Empty;
            return Session["APIToken"].ToString();
        }
        set { Session["APIToken"] = value; }
    }
    public static string RestAPIToken
    {
        get
        {
            if (Session["RestAPIToken"] == null) Session["RestAPIToken"] = string.Empty;
            return Session["RestAPIToken"].ToString();
        }
        set { Session["RestAPIToken"] = value; }
    }
    public static string RefreshAPIToken
    {
        get
        {
            if (Session["RefreshAPIToken"] == null) Session["RefreshAPIToken"] = string.Empty;
            return Session["RefreshAPIToken"].ToString();
        }
        set { Session["RefreshAPIToken"] = value; }
    }
    ...
    public static string IOPTokenExp
    {
        get
        {
            if (Session["IOPTokenExp"] == null) Session["IOPTokenExp"] = "";
            return (string)Session["IOPTokenExp"];
        }
        set { Session["IOPTokenExp"] = value; }
    }
    ...
    public static bool DisableAPMLink
    {
        get
        {
            if (Session["DisableAPMLink"] == null) Session["DisableAPMLink"] = false;
            return (bool)Session["DisableAPMLink"];
        }
        set { Session["DisableAPMLink"] = value; }
    }
    public static string SelectedProviderAdminUserID
    {
        get
        {
            if (Session["SelectedProviderAdminUserID"] == null) Session["SelectedProviderAdminUserID"] = "";
            return (string)Session["SelectedProviderAdminUserID"];
        }
        set { Session["SelectedProviderAdminUserID"] = value; }
    }
    public static string SelectedProviderAdminUserName
    {
        get
        {
            if (Session["SelectedProviderAdminUserName"] == null) Session["SelectedProviderAdminUserName"] = "";
            return (string)Session["SelectedProviderAdminUserName"];
        }
        set { Session["SelectedProviderAdminUserName"] = value; }
    }
}
