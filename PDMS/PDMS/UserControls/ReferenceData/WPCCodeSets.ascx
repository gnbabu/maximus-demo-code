<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_ReferenceData_WPCCodeSets" Codebehind="WPCCodeSets.ascx.cs" %>
...
<div class="row">
    <div class="col-sm-3 text-right"><span class="ohio-field">Codesets</span></div>
    <div class="col-sm-9 text-left">
        <telerik:radcombobox id="ddlWPCCodeSet" runat="server" width="600px" enableariasupport="true" ariasettings-label="Jump To"
...
<div class="divGrid">
    <asp:GridView
        ...
        AllowPaging="true"
        PageSize="50"
        OnPageIndexChanging="gvWPCCodeSets_PageIndexChanging">
        <Columns>
            <asp:BoundField ReadOnly="true" DataField="WPC_Code" HeaderText="WPC Code" />
            <asp:BoundField ReadOnly="true" DataField="WPC_Description" HeaderText="WPC Description" />
            <asp:BoundField ReadOnly="true" DataField="START_DATE" HeaderText="WPC START DATE" />
            <asp:BoundField ReadOnly="true" DataField="END_DATE" HeaderText="WPC END DATE" />
