<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_ReferenceData_RDMCodeSets" Codebehind="RDMCodeSets.ascx.cs" %>
...
<div class="row">
    ...
    <div class="col-sm-9 text-left">
        <%--<asp:DropDownList ID="ddlRDMCodeSet" runat="server" CssClass="formDropDown" OnInit="ddlRDMCodeSet_Init" > </asp:DropDownList>--%>
        <telerik:radcombobox id="ddlRDMCodeSet" runat="server" width="600px" enableariasupport="true" ariasettings-label="Jump To"
...
<div class="divGrid">
    <asp:GridView
        ...
        <Columns>
            ...
            <asp:BoundField ReadOnly="true" DataField="RDM_Code" HeaderText="RDM Code" />
            <asp:BoundField ReadOnly="true" DataField="RDM_Description" HeaderText="RDM Description" />
            <asp:BoundField ReadOnly="true" DataField="START_DATE" HeaderText="RDM START DATE" />
            <asp:BoundField ReadOnly="true" DataField="END_DATE" HeaderText="RDM END DATE" />
