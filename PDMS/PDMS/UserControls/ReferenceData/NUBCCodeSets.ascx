<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_ReferenceData_NUBCCodeSets" Codebehind="NUBCCodeSets.ascx.cs" %>
...
<div class="row">
    ...
    <div class="col-sm-9 text-left">
        ...
        <telerik:radcombobox id="ddlNUBCCodeSet" runat="server" width="600px" enableariasupport="true" ariasettings-label="Jump To"
