<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_ReferenceData_CMSCodeSets" Codebehind="CMSCodeSets.ascx.cs" %>
...
<div class="row">
    ...
    <div class="col-sm-9 text-left">
        <%--<asp:DropDownList ID="ddlCMSCodeSet" runat="server" CssClass="formDropDown" OnInit="ddlCMSCodeSet_Init" > </asp:DropDownList>--%>
        <telerik:radcombobox id="ddlCMSCodeSet" runat="server" width="600px" enableariasupport="true" ariasettings-label="Jump To"
...
<div class="divGrid">
    <asp:GridView
        ...
        AllowPaging="true"
        PageSize="100"
        OnPageIndexChanging="gvCMSCodeSets_PageIndexChanging">
        <Columns>
            <asp:BoundField ReadOnly="true" DataField="CMS_Code" HeaderText="CMS Code" />
            <asp:BoundField ReadOnly="true" DataField="CMS_Description" HeaderText="CMS Description" />
