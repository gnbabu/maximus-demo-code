<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_GroupAffiliationsHistory" Codebehind="GroupAffiliationsHistory.ascx.cs" %>
<br />
<asp:UpdatePanel ID="upGrd" runat="server" UpdateMode="Conditional">
    ...
    <div class="btnBox text-center" runat="server" style="padding-right:8px">
        <asp:Button ID="btnOk" runat="server" Text="Ok" CssClass="buttonBox" OnClick="btnOk_Click" CausesValidation="false" />
    </div>
    </ContentTemplate>
</asp:UpdatePanel>
