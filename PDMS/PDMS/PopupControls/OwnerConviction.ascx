<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_OwnerConviction" Codebehind="OwnerConviction.ascx.cs" %>
...
<asp:HiddenField ID="hdnRegOwnerConvictionID" runat="server" />
