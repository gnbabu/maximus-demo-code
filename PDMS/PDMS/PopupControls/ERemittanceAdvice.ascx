<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_ERemittanceAdvice" Codebehind="ERemittanceAdvice.ascx.cs" %>
...
<div>
    ...
    <asp:Panel runat="server" ID="pnlSepInstructions" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);"  Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="CollapsingSeparator">
        <h1><span id="sepInstructions" runat="server" class="pageHeader pH2" Style="color:white"><button type="button" class="panelHeaderStyle" tabindex="0" id="remSearch" aria-expanded="true" onclick="CollapseExpandRemittanceSearch()">* 
            Remittance Advice Search
        </button></span></h1>
    </asp:Panel>
    <asp:Panel ID="pnlInstructions" runat="server" style="height: 380px;">
        <div>
            <div>
        ...
        <div class="layoutTable" role="presentation">
         ...
         <div class="btnBox btnBoxCenter">
             <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                 <ContentTemplate>
                     <asp:Button ID="btnSearch" runat="server" CausesValidation="true" Text="Search" CssClass="buttonBoxFocusBlue" OnClick="btnSearch_Click" ValidationGroup="valProviderHeader"  />
        ...
        <br/><br/>
        <div id="spacingSpacer" style="height: 50px;">&nbsp;</div>
    ...
    <asp:Panel runat="server" ID="pnlSepOwnInfo" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse">
        <h1><span id="sepOwnInfo" runat="server" class="pageHeader pH2" Style="color:white"><button type="button" class="panelHeaderStyle" tabindex="0" id="remSearchResult" aria-expanded="true" onclick="CollapseExpandRemittanceSearchResult()"> Remittance Advice Search Result</button></span></h1> </asp:Panel>
