...
public partial class PopupControls_HeaderOtherPayerAdjustmentMapping : System.Web.UI.UserControl
{
    ...
    public void SetOtherPayerAdjustmentInfoPanelData(List<OtherPayerAdjustmentInfo> OtherPayerAdjInfo, DataSet dsOtherPayerInfo)
    {
        ...
        if (Helper.HasRows(dsotherPayerAdjus))
        {
            ...
            providerHeaderAdjustmentdentalOutput.InnerHtml = "";
            if (otherpayerAdjusTable.Rows.Count > 0)
            {
                ...
                tab = tab + "</tbody></table>";
                providerHeaderAdjustmentdentalOutput.InnerHtml = tab;
            }

        }
        else { providerHeaderAdjustmentdentalOutput.InnerHtml = ""; }
    ...
    public void GetAdjustmentGroup()
    {
        ...
        ddlOtherPayerAdjustmentGroup.Items.Clear();
        DataSet dataSet = _svc.GetAdjustmentGroup();
    ...
    //        ClaimsController.UpdatePanelsData("claims_header_other_payer_adjustment_information", parms);
    //        List<OtherPayerAdjustmentInfo> listData = new List<OtherPayerAdjustmentInfo>();
    //        gvOtherPayerAdjustmentInfo.EditIndex = -1;
    //        this.SetOtherPayerAdjustmentInfoPanelData(listData, null);
    //    }
    ...
    //    _svc.DeletePanelsData("claims_header_other_payer_adjustment_information", "Claims_Header_Other_Payer_Adjustment_Information_ID", Convert.ToInt32(hdnOtherPayerAdjustmentInfo.Value));
    ...
    //    HiddenField hdnreasoncode = (HiddenField)gvOtherPayerAdjustmentInfo.Rows[e.RowIndex].FindControl("hdnreasoncode");
    //    HiddenField hdnAdjustgrp = (HiddenField)gvOtherPayerAdjustmentInfo.Rows[e.RowIndex].FindControl("hdnAdjustgrp");
    //    HiddenField hdnOtherPayerAdjustmentInfo = (HiddenField)gvOtherPayerAdjustmentInfo.Rows[e.RowIndex].FindControl("hdnOtherPayerAdjustmentInfo");
