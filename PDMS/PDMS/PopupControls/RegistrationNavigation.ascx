<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_RegistrationNavigation" Codebehind="RegistrationNavigation.ascx.cs" %>
        ...
        <asp:View runat="server" ID="vwProviderServices">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right" style="display: flex; justify-content: flex-end; gap: 10px; padding-right: 5px !important;">
