<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_SearchMemberEligibility" Codebehind="SearchMemberEligibility.ascx.cs" %>
...
<div class="resultContainer1 active">
    <div class="content cForm">
        ...
        <div class="row" style="padding-top: 30px; text-align: center;">
            <div class="row-centered col-lg-12" style="padding-top: 30px !important; text-align: center;">

                <button id="btnSearch" type="button" class="buttonBoxFocusBlue"  onclick="makeMemberEligibilityPageRequest()">Search</button>
                <button id="btnClear" type="button" class="buttonBoxFocusred" onclick="clearForm()">Clear</button>
                <button id="btnPrint" type="button" class="btn btn-primary margin-right-n btn-success printme" style="background-color: #286090 !important; display: none" onclick="makePrintPageRequest()">Print</button>
            </div>
        </div>
    </div>
</div>
