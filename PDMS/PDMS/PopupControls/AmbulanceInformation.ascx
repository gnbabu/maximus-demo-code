<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_AmbulanceInformation" Codebehind="AmbulanceInformation.ascx.cs" %>
...
<asp:UpdatePanel ID="updatePaneAmbulanceInformation" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel runat="server" ID="pnlsepToothQuadrantInfo" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc" ToolTip="Click to Expand/Collapse" CssClass="OwnerToothQuadrantInfo">
            ...
            <span id="sepToothQuadrantInfo" runat="server" class="pageHeader pH2">+  <span class="pageHeader pH2 GridviewHeaderAsterisk"></span>AMBULANCE INFORMATION <span style="color: red; font-size: 15px;">[Required ONLY for Transportation Claims]</span> </span>
        </asp:Panel>
