<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_SiteVisits" Codebehind="SiteVisits.ascx.cs" %>
    ...
    <div class="divGrid"  style="display:block;">
        <asp:GridView runat="server" Width="98%" ID="grdSiteVisits" AutoGenerateColumns="False" HorizontalAlign="Left" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SITE_VISIT_DISPOSITION_COMMENTS" HeaderText="Notes" />
            </Columns>
