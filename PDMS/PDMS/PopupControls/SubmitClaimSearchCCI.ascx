<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_SubmitClaimSearchCCI" Codebehind="SubmitClaimSearchCCI.ascx.cs" %>
...
<div class="row" style="text-align: center; margin-left:10px; margin-right:10px;" >
   <div class="row" style="text-align: center;">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 ">
            <span class="ohio-field-label"><b>Condition Code</b>
                <asp:TextBox ID="txtCode" CssClass="ohio-field-input" runat="server"></asp:TextBox>
            </span>
        </div>

        <div class="col-sm-6 col-md-4 col-lg-6 ">
            <span class="ohio-field-label"><b>Condition Code Description</b>
...
<mms:SortablePagingGridView
    ...
    DataKeyNames="ConditionCode, ConditionDesc">
    <Columns>
        <asp:BoundField DataField="ConditionCode" HeaderText="Condition Code" SortExpression="ConditionCode" />
        <asp:BoundField DataField="ConditionDesc" HeaderText="Condition Code Description" SortExpression="ConitionDesc" />
    </Columns>
</mms:SortablePagingGridView>
</div>
