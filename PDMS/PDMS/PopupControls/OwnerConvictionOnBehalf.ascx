<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_OwnerConvictionOnBehalf" Codebehind="OwnerConvictionOnBehalf.ascx.cs" %>
...
<asp:UpdatePanel ID="upSSN" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <div>
            <asp:ValidationSummary ID="vsOwnerConviction" runat="server" DisplayMode="List" ValidationGroup="valOwnerConvictionOnBehalf" />
        </div>
        <div>
        ...
        <tr>
                ...
                <td>
                   <asp:DropDownList ID="ddlOwner" runat="server" CssClass="formDropDown" OnSelectedIndexChanged="ddlOwner_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="True" />
                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ValidationGroup="valOwnerConvictionOnBehalf"
             ...
             <tr>
              ...
              <tr>
                ...
                <td>
                    <asp:TextBox ID="txtExplaination" runat="server" CssClass="formField" MaxLength="255" TextMode="MultiLine" Rows="4" />
                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ValidationGroup="valOwnerConvictionOnBehalf"
...
<asp:HiddenField ID="hdnRegOwnerConvictionOnBehalfID" runat="server" />
