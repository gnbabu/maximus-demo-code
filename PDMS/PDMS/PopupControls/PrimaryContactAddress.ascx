<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_PrimaryContactAddress" Codebehind="PrimaryContactAddress.ascx.cs" %>
    ...
    <ContentTemplate>
        <div id="PrimaryContactAddress" runat="server" style="width: 100%;">
           ...
           <span style="color:#df2012; font-size: 14pt !important"><b>An asterisk * indicates a required field</b></span>
                    <div class="row">
                  <div class="col-sm-4  text-right"><span class="formLabel200">Override Address Validation</span></div>
                <div class="col-sm-8" id="div1" runat="server">
               <asp:CheckBox ID="primaryContactAddress_override" Checked="false" runat="server" CssClass="formFieldCheckBox" OnCheckedChanged="prov_Override_CheckedChanged" AutoPostBack="true" style="border:none" />
                ...
                <div class="row">
                    ...
                    <div id="divContactName" class="col-sm-8" runat="server">
