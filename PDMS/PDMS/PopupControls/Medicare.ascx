<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_Medicare" Codebehind="Medicare.ascx.cs" %>
...
<div id="hstryNewdiv" style="text-align: right; padding-top: 15px;">
    ...
    <a href="javascript:void(0);" class="buttonBoxFocus hbtn-focus" onclick="GoToHistory(event, 'Medicare');" title="History"><img src="../Images/HistoryIcon1.png" alt="History Icon" class="history-icon" />History</a>
</div>
