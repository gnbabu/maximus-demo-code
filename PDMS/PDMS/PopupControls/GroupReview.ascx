<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_GroupReview" Codebehind="GroupReview.ascx.cs" %>
...
<cc1:GroupBox ID="gbSearch" CaptionStyle-CssClass="bodyTextBold" Width="100%" runat="server">
    ...
    <asp:Panel ID="pnlFilter" runat="server" DefaultButton="btnSearch">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 outerName">
                            ...
                            <div tabindex="0" aria-label="Waiver Type" >
                                <asp:DropDownList ID="ddlWaiverType"  CssClass="form-control unsetPublicSearchDDLLength" style="margin-top:5px;" runat="server" aria-Label="Waiver Type" AutoPostBack="True" OnSelectedIndexChanged="ddlWaiver_SelectedIndexChanged" >
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 outerName">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 outerName">
                            ...
                            <asp:TextBox ID="txtDODDContractNumber" aria-label="DODD Number" CssClass="ohio-field-input" runat="server" MaxLength="7" style="margin-top:5px;" />
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 outerName">
                            ...
                            <div taxindex="0">
                                ...
                                <asp:RegularExpressionValidator ID="revtxtRegID" runat="server" ControlToValidate="txtRegID"
                                    ValidationExpression="\d{0,10}" ErrorMessage="* Enter Reg ID (max 10 digits)."
                                    Enabled="true" SetFocusOnError="true"
                                    ValidationGroup="ProviderSearch" Display="Dynamic" />
                            </div>
                        </div>
                ...
                <ContentTemplate>
                    <div class="row">
                       <%-- <div class="col-sm-6 col-md-4 col-lg-3 outerName">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 outerName">
                            <asp:Label ID="lblRiskLevel" class="ohio-select" AssociatedControlID="ddlRiskLevel" runat="server" style="margin-bottom:0px;">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 outerName">
                            <asp:Label ID="lblArea" class="ohio-select" AssociatedControlID="ddlArea" runat="server" style="margin-bottom:0px;">
        ...
        <div class="btnBoxCenterGroupReview">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:Button ID="btnSearch" runat="server" CausesValidation="true" Text="Search" CssClass="buttonBoxFocusGroupReview" OnClick="btnSearch_Click" ValidationGroup="ProviderSearch" OnClientClick="showProgress()" />
                    <asp:Button ID="btnClear" runat="server" CausesValidation="false" Text="Clear" CssClass="buttonBoxFocusRedGroupReview" OnClick="btnClear_Click" OnClientClick="showProgress()" />
                </ContentTemplate>
                <Triggers>
...
<asp:Panel ID="pnlExpressAdmin" runat="server" CssClass="adminPopUpFullSize adminModalPopup" Style="display: none">
    <asp:MultiView ID="mltExpressAdmin" runat="server" ActiveViewIndex="0" EnableViewState="true">
        <asp:View ID="vwSelection" runat="server">
            <asp:Panel ID="pnlAdminMaintenance" runat="server" Style="height: auto; width: 100%;">
                ...
                <div class="btnBox" style="padding-top: 20px; padding-right: 10px;">
                    ...
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="buttonBoxFocusred" OnClick="btnCancel_Click" CausesValidation="false" />
                </div>
            </asp:Panel>
        </asp:View>
        ...
        <asp:View ID="vwRemoveExclusion" runat="server">
            <asp:Panel ID="Panel3" runat="server" Style="height: auto; width: auto;">
                <asp:Panel ID="Panel4" CssClass="popHeader" runat="server">
                    <div class="popTitle">Remove Exclusion</div>
                </asp:Panel>
                <div>
                    <div class="row">
                        <div class="col-sm-2"></div>
                        <div class="col-sm-10">
                            <asp:Label ID="lblErrRemExcl" runat="server" Visible="false" CssClass="failureNotification" />
                        </div>
                    </div>
                    <div class="row" style="margin-top: 2em;">
                        <div class="col-sm-3 text-right" style="margin-top: 0.4em;">
                            <strong>Select Exclusion</strong><span class="text-danger">*</span>

                        </div>
                        <div class="col-sm-9">
                            <asp:DropDownList ID="ddlSelectExclusion"  CssClass="formField" AutoPostBack="false" runat="server" AppendDataBoundItems="True">
                                  <asp:ListItem Selected="False"></asp:ListItem>
                                  <asp:ListItem Selected="False" Text="OIG/LEI Exclusion" Value="0"></asp:ListItem>
                                  <asp:ListItem Selected="False" Text="SAM Exclusion" Value="1"></asp:ListItem>
                                  <asp:ListItem Selected="False" Text="Medicaid Exclusion" Value="2"></asp:ListItem>
                                  <asp:ListItem Selected="False" Text="Medicare Exclusion" Value="3"></asp:ListItem>
                                  <asp:ListItem Selected="False" Text="NPPES" Value="4"></asp:ListItem>
                            </asp:DropDownList>                          
                        </div>
                    </div>
                    <div class="row" style="margin-top: 2em;">
                        ...
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtRemoveExclComments" aria-label="request" runat="server" 
                                  MaxLength="1000" CssClass="modalFormField" TextMode="MultiLine" Columns="100" Rows="7" />                              
                        </div>
                    </div>
                     <div class="btnBox" style="padding-top: 20px; padding-right: 10px;">
                        <asp:Button ID="btnSaveRemoveExclusion" runat="server" Text="Save" CssClass="buttonBoxFocus" OnClick="btnSaveRemoveExclusion_Click" CausesValidation="true" />
                        <asp:Button ID="btnCancelRemoveExclusion" runat="server" Text="Cancel" CssClass="buttonBox" OnClick="btnCancelProvRec_Click" CausesValidation="false" />
                    </div>
                </div>
            </asp:Panel>    
        </asp:View>
        <asp:View ID="vwRevertSuspend" runat="server">
         ...
         <asp:View ID="vwSiteVisit" runat="server">
             <asp:Panel ID="pnlSiteVisit" runat="server" Style="height: auto; width: auto;">
                 <asp:Panel ID="pnlSiteVisitHdr" CssClass="popHeader" runat="server">
                     <div class="popTitle">
                         <div class="popTitle">New Site Visit Event</div>
                     </div>
                 </asp:Panel>
                 <div>
                     <br />
                     <div class="row">
                         <div class="col-sm-2"></div>
                         <div class="col-sm-10">
                             <span class="formLabel" style="font: bold; text-align: center">Start a New Site Visit Event </span>
                         </div>
                     </div>
                     <div class="row">
                         <div class="col-sm-2"></div>
                         <div class="col-sm-10">
                             <asp:Label ID="lblSvErrMsg" runat="server" Visible="false" CssClass="formLabel" />
                         </div>
                     </div>
                     <div class="btnBox" style="padding-top: 20px; padding-right: 10px;">
                         <asp:Button ID="btnStartSiteVisitEvent" runat="server" Text="Save" CssClass="buttonBoxFocus" OnClick="btnStartSiteVisitEvent_Click" CausesValidation="true" />
                         <asp:Button ID="btnCancelSiteVisitEvent" runat="server" Text="Cancel" CssClass="buttonBox" OnClick="btnCancelSiteVisitEvent_Click" CausesValidation="false" />
                     </div>
                 </div>
             </asp:Panel>
         </asp:View>
