<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_HeaderOtherPayerAdjustmentMappingInstitutional" Codebehind="HeaderOtherPayerAdjustmentMappingInstitutional.ascx.cs" %>
...
<script type="text/javascript">
    ...
    function loadAddHeaderOtherPayerInstitutional() {
    ...
    function onlyDotsAndNumbersWithNegetive(txt, event) {
        ...
        function visibleReasonCode()
        {
            ...
            $find("mpeReasonCode").show();
        return false;
   
}

    function CloseReasonPopupInstitutional() {
        $('#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ucSubmitClaimSearchReason_txtCode').val('');
        $('#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ucSubmitClaimSearchReason_txtPlaceOfServiceName').val('');
        $('#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ucSubmitClaimSearchReason_gvSubmitClaimSearchPop').find('tbody').html('');
    } 
    function DisableEnableConditionAddButton() {
        setTimeout(function () {
            $("ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_btnOtherPayerAdjustmentInfoAdd").prop("disabled", true)
        }, 50);
        setTimeout(function () {
            $("ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_btnOtherPayerAdjustmentInfoAdd").prop('disabled', false);
        }, 1000);
    }
    ...
    function otherPayerInstHeaderDetailBind() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (claimHeaderOtherAdjustmentInstiList.length > 0) {
                    ...
                    document.getElementById('<%= providerHeaderAdjustmentinstiOutput.ClientID %>').innerHTML = table;
                      HeaderAdjInstiClearFields();
                      BindHeaderOtherAdjustmentGroupDropdown();
                  }
                  else {
                     document.getElementById('<%= providerHeaderAdjustmentinstiOutput.ClientID %>').innerHTML = "";
                 }
    ...
    function GetHeaderAndOtherPayercode(lnk) {
        ...
        if (!(gridindexReasoncode == "")) {
         ...
         <%--  var grid = document.getElementById("<%= gvOtherPayerAdjustmentInfo.ClientID%>");--%>
            ...
            $("[id*=ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_txtOtherPayerReasonCode]").val(textboxrow.cells[0].innerText.trim());
    ...
    function InstitutionalReasonCodetextChange() {
    ...
    function AddButtonInstitutionalHeaderOtherAdjustment() {
        $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('');
              ...
              $.ajax({
                  ...
                  success: function (result) {
                      ...
                      if (result[0].lblErrorMessageHeaderOtherAdjustment) {
                          $("[id*=lblErrorMessageHeaderOtherAdjustment]").text(result[0].lblErrorMessageHeaderOtherAdjustment);
                      }
                      else {
                          var table;
                          if (claimHeaderOtherAdjustmentInstiList.length > 0) {
                              ...
                              document.getElementById('<%= providerHeaderAdjustmentinstiOutput.ClientID %>').innerHTML = table;
                              HeaderAdjInstiClearFields();
                              BindHeaderOtherAdjustmentGroupDropdownInsti();
                          }
                          else {
                              HeaderAdjInstiClearFields();
                          }
                      ...
                      error: function (jqXHR, textStatus, errorThrown) {
                          $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('no data found');
                      }
        ...
        function validateFields() {
            ...
            if ((ddlOtherPayerHealthPlanID === null || ddlOtherPayerHealthPlanID === "" || ddlOtherPayerHealthPlanID === undefined)) {
                ...
                validateField = "false";
                $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('Health plan ID is required');
                    return false;
            ...
            if ((ddlOtherPayerAdjustmentGroup === null || ddlOtherPayerAdjustmentGroup === "" || ddlOtherPayerAdjustmentGroup === undefined)){
                    ...
                    validateField = "false";
                $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('Adjustment group is required');
                    return false;
            ...
            if ((txtOtherPayerReasonCode === null || txtOtherPayerReasonCode === "" || txtOtherPayerReasonCode === undefined)) {
                ...
                validateField = "false";
                $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('Reason code is required');
                return false;
            ...
            if ((txtOtherPayerAmount === null || txtOtherPayerAmount === "" || txtOtherPayerAmount === undefined)) {
                ...
                validateField = "false";
                $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('Amount is required');
                return false;
            ...
            if ((txtOtherPayerQuantity !== null || txtOtherPayerQuantity !== "" || txtOtherPayerAmount !== undefined)) {
                if (txtOtherPayerQuantity.charAt(0) === "0") {
                    validateField = "false";
                    $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('Invalid Quantity');
                    return false;
                }
            }
            else {
    ...
    function EditHeaderAdjustmentOtherPayerInfo_Institutional() {
        ...
        if (validateField === "true") {
            ...
            $.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('Data not found.');
                }
            });
        }
            return false;
    ...
    function EditFieldsHeaderAdjustmentInstitutional(claim_id, Claims_Header_Other_Payer_Adjustment_Information_ID,control) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (claimHeaderOtherAdjustmentInstiList.length > 0) {
                    ...
                    for (var i = 0; i < claimHeaderOtherAdjustmentInstiList.length; i++) {
                        ...
                        ReloadAdjustmentGrouponEditClickInsti(Claim_ID, HealthPlanID, AdjustmentGroup);
                        $('#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerAdjustmentGroup option:contains("' + AdjustmentGroup + '")').prop('selected', true);
                        $('#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerHealthPlanID option:contains("' + HealthPlanID + '")').prop('selected', true);
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('try again..');
            }
        });
    ...
    function HeaderAdjInstiClearFields() {
        ...
        if (document.getElementById("ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerHealthPlanID").options.length > 0) {
            if (document.getElementById("ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerHealthPlanID").options[0]!=null)
            document.getElementById("ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerHealthPlanID").options[0].selected = true;
        }
        if (document.getElementById("ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerAdjustmentGroup").options.length > 0) {
            document.getElementById("ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerAdjustmentGroup").options[0].selected = true;
        }
        $("#<%= txtOtherPayerReasonCode.ClientID %>").first().val("");
        $("#<%= txtOtherPayerAmount.ClientID %>").first().val("");
        $("#<%= txtOtherPayerQuantity.ClientID %>").first().val("");
        document.getElementById('<%= lblErrorMessageHeaderOtherAdjustment.ClientID%>').innerHTML = '';
        $("#<%= lblErrorMessageHeaderOtherAdjustment.ClientID %>").html("");
    ...
    function ddlHeaderOtherPayerHealthPlanIDInstitutional_SelectedIndexChanged() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerAdjustmentGroup").empty();
                $("#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerAdjustmentGroup").append($('<option value=""></option>'));
                for (var i = 0; i < ddAdjustmentCodeResult.length; i++) {
                    ...
                    $("#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerAdjustmentGroup").append(newOption);
                }
                $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('');
            },
            error: function (jqXHR, textStatus, errorThrown) {
                $("[id*=lblErrorMessageHeaderOtherAdjustment]").text('try again later..');
            }
        });
    }

    function BindHeaderOtherAdjustmentGroupDropdownInsti() {
        var APIToken = $("[id*=hdnAccessToken]").val();
        $.ajax({
            type: "GET",
            ...
            success: function (result) {
                ...
                for (var i = 0; i < data.length; i++) {
                    $("#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerAdjustmentGroup").append($('<option></option>').attr("value", data[i].PRIOR_AUTH_CLAIM_ADJUSTMENTGROUP_ID).text(data[i].PRIOR_AUTH_CLAIM_ADJUSTMENTGROUP_DESC));
                }
            },
            error: function (jqXHR, textStatus, errorThrown) {
            }
    ...
    function ReloadAdjustmentGrouponEditClickInsti(Claim_ID, HealthPlanID, ClickedAdjustmentGroup) {
        var APIToken = $("[id*=hdnAccessToken]").val();
        $.ajax({
            type: "GET",
            ...
            success: function (result) {
                ...
                for (var i = 0; i < FilteredDropdownValues.length; i++) {
                    $("#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerAdjustmentGroup").append($('<option></option>').attr("value", FilteredDropdownValues[i].cde_adjustment_group).text(FilteredDropdownValues[i].cde_adjustment_group));
                }
                $('#ctl00_MainContent_uc5SubmitClaim_ucSSubmitClaimHeaderOtherPayerAdjustmentMappingInstitutional_ddlOtherPayerAdjustmentGroup').find('option').filter(function () {
...
<asp:Panel ID="pnlOtherPayerAdjustmentInformation" runat="server" Style="overflow-x: hidden; height:auto; padding-top: 20px; padding-bottom: 20px;">
    <asp:UpdatePanel ID="upnlOtherPayerAdjustmentInformation" runat="server">
        <ContentTemplate>
            ...
            <asp:Label runat="server" CssClass="failureNotification" ID="lblPanelTopErrorMessage"> </asp:Label>
        </div>
            <div class="row" style="text-align: center; width: 97%; margin-left: 1%">
                ...
                <div class="divGrid" style="padding-right: 20px;">
                      <div id="providerHeaderAdjustmentinstiOutput" runat="server"></div>
             <%--       <asp:GridView ID="gvOtherPayerAdjustmentInfo" runat="server" AllowSorting="false" CssClass="gridview"
                        ...
                        <asp:TemplateField HeaderText="Health Plan ID" >
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:HiddenField ID="hdnOtherPayerAdjustmentInfoIns" Value='<%# Bind("Claims_Header_Other_Payer_Adjustment_Information_ID") %>' runat="server" />
                        ...
                        <asp:TemplateField HeaderText="Adjustment Group">
                            ...
                            <EditItemTemplate>
                                <asp:HiddenField ID="hdnAdjustgrpIsn" Value='<%# Bind("cde_adjustment_group") %>' runat="server" />
                        ...
                        <asp:TemplateField HeaderText="Reason Code" >
                                ...
                                <EditItemTemplate>
                                <asp:HiddenField ID="hdnreasoncodeIns" Value='<%# Bind("cde_reason_code") %>' runat="server" />
            ...
            <br />
            <div id="divHeaderOth" runat="server">
            ...
            <div class="row" style="padding-left: 70px;">
                ...
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlOtherPayerHealthPlanID" CssClass="formFieldTextBoxSmall" EnableViewState="true" runat="server"
                        AppendDataBoundItems="True" Style="height: 30px; width: 180px; min-width: 180px;" ValidationGroup="vldheaderInstitution" class="selectdropdown" onChange="return ddlHeaderOtherPayerHealthPlanIDInstitutional_SelectedIndexChanged()">
                    </asp:DropDownList><br />
                ...
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlOtherPayerAdjustmentGroup" CssClass="formFieldTextBoxSmall" EnableViewState="true" runat="server"
                        AppendDataBoundItems="true" Style="height: 30px; width: 158px; min-width: 180px;" ValidationGroup="vldheaderInstitution" class="selectdropdown">
                    </asp:DropDownList>
              <%--      <asp:RequiredFieldValidator runat="server" ID="rfvOtherPayerAdjustmentGroup" SetFocusOnError="true"
                ...
                <div class="col-sm-3">
                    <asp:TextBox ID="txtOtherPayerReasonCode" runat="server" MaxLength="5" CssClass="formFieldTextBoxSmall" Style="height: 30px; width: 170px" Height="30px" ValidationGroup="validateClaimsDental" OnChange="return InstitutionalReasonCodetextChange()"  />
                    ...
                    <asp:LinkButton ID="lnkOtherPayerReasonSearch" runat="server" ToolTip="Search" Text="Search"  style="font-size:14px;"
                         CommandArgument='<%# Eval("ID_PROVIDER") %>' OnClientClick="return visibleReasonCode()" Visible="true"></asp:LinkButton>&nbsp;&nbsp;
                    <br/>                    
              <%--      <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" SetFocusOnError="true"
                        ...
                        Text="*Enter ReasonCode" Display="Dynamic" InitialValue="" />  --%>              
                </div>
                <div class="col-sm-2">
                    <asp:TextBox ID="txtOtherPayerAmount" onkeypress="return onlyDotsAndNumbersWithNegetive(this,event);"
                        runat="server" CssClass="formFieldTextBoxSmall" MaxLength="18" Style="height: 30px; width: 200px;" ValidationGroup="validateClaimsDental" />
                ...
                <div class="col-sm-1">
                    ...
                    <asp:Button ID="btnOtherPayerAdjustmentInfoAdd" Text="Add" OnClientClick="return AddButtonInstitutionalHeaderOtherAdjustment();" runat="server" CssClass="btn btn-primary" ValidationGroup="validateClaimsDental" 
                ...
                <br />
              <div class="row" style="padding-left: 70px;">
             <asp:Label runat="server" CssClass="failureNotification" ID="lblErrorMessageHeaderOtherAdjustment"> </asp:Label>
                  </div>   
                </div>
        </ContentTemplate>
    </asp:UpdatePanel>
...
<ajax:ModalPopupExtender BehaviorID="mpeReasonCode" ID="mpeSubmitClaimSearchReason" runat="server" PopupControlID="pnlSubmitClaimSearchReason" TargetControlID="ButtonSearchReason" BackgroundCssClass="modalBackground" CancelControlID="btnCloseReason" />

<asp:Panel ID="pnlSubmitClaimSearchReason" runat="server" CssClass="modalPopup" Style="display: none; min-height: 500px; min-width: 800px; height: auto; width: auto;">
    <asp:Panel ID="pnlSubmitClaimSearchReasonHeader" CssClass="popHeader" runat="server" HorizontalAlign="Left">
        <asp:Button runat="server" ID="btnCloseReason" Text="X" Style="float: right; background-image: none; border: 0px; border-radius: 0px;" CausesValidation="false" OnClientClick="CloseReasonPopupInstitutional();"/>
