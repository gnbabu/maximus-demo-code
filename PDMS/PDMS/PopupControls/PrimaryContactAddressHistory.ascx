<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_PrimaryContactAddressHistory" Codebehind="PrimaryContactAddressHistory.ascx.cs" %>
<br />
<asp:GridView runat="server" Width="98%" 
    ID="grdPrimaryContactInfoHistory" AutoGenerateColumns="False" HorizontalAlign="Left"  CssClass="gridview" EmptyDataText="No entries found." 
    onrowdatabound="grdPrimaryContactInfoHistory_RowDataBound"  AllowPaging="true" AllowSorting="True" PageSize="10"
