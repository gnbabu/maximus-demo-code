<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_CredentialingReturntoProviderReasons" Codebehind="CredentialingReturntoProviderReasons.ascx.cs" %>
                            ...
                            <ItemTemplate>
                                <div style="display: table-row;">
                                    ...
                                    <asp:HiddenField ID="hdnErrorTypeID" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ERROR_TYPE_ID") %>' />
                                     <asp:HiddenField ID="hdnErrorType" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ERROR_NAME") %>' />
                                </div>
                            </ItemTemplate>
                        </asp:ListView>
                    </asp:Panel>
