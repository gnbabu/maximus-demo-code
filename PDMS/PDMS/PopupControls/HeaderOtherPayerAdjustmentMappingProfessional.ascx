<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_HeaderOtherPayerAdjustmentMappingProfessional" Codebehind="HeaderOtherPayerAdjustmentMappingProfessional.ascx.cs" %>
...
<script>
    function otherPayerProfHeaderDetailBind() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (claimHeaderOtherAdjustmentInstiList.length > 0) {
                ...
                document.getElementById('<%= providerHeaderAdjustmentinstiOutputProf.ClientID %>').innerHTML = table;
                      HeaderAdjInstiClearFields();
                      BindHeaderOtherAdjustmentGroupDropdown();
                  }
                  else {
                    document.getElementById('<%= providerHeaderAdjustmentinstiOutputProf.ClientID %>').innerHTML = "";
                }
            },
    ...
    function loaderOtherPayerReasonCode() {
...
document.getElementById('<%= txtOtherPayerQuantity.ClientID %>').disabled = true;
       <%-- ////////document.getElementById('<%= btnOtherPayerReason.ClientID %>').style.display = 'block';--%>
    }
    function loaderProfessionalHeaderOtherPayerDetails() {
        ...
        var Amount = $("#<%= txtOtherPayerAmount.ClientID %>").first().val();
        var Quantity = $("#<%= txtOtherPayerQuantity.ClientID %>").first().val();

        if (HealthPlanID != "" && AdjustmentGroup != "" && ReasonCode != "" && Amount != "" && Quantity != "") {
            document.getElementById('<%= ddlOtherPayerHealthPlanID.ClientID %>').disabled = true;
            document.getElementById('<%= ddlOtherPayerAdjustmentGroup.ClientID %>').disabled = true;
            document.getElementById('<%= txtOtherPayerReasonCode.ClientID %>').disabled = true;
            document.getElementById('<%= txtOtherPayerAmount.ClientID %>').disabled = true;
    ...
    function ProfReasonCodetextChange() {
        ...
        var APIToken = $("[id*=hdnAccessToken]").val();
         $.ajax({
             ...
             success: function (result) {
                 if (result === "") {
                     $("[id*=lblHeaderDentalerror]").text('Reason code not found.');
                 }
                 else {
                     //$("[id*=lblValueCodeDesc]").text(result[0]["CLAIMS_REASON_CODE_DESC"]);
                     $("[id*=lblHeaderDentalerror]").text('');
                 }
             },
             error: function (jqXHR, textStatus, errorThrown) {
                 $("[id*=lblHeaderDentalerror]").text('Reason code not found.');
    ...
    function AddButtonInstitutionalHeaderOtherAdjustmentProf() {
       ...
       // $("[id*=lblErrorMessageHeaderOtherPayerDental]").text('');
              ...
              $.ajax({
                  ...
                  success: function (result) {
                      ...
                      if (result[0].lblErrorMessageHeaderOtherAdjustment) {
                          $("[id*=lblErrorMessageHeaderOtherProf]").text(result[0].lblErrorMessageHeaderOtherAdjustment);
                      }
                      else {
                          var table;
                          if (claimHeaderOtherAdjustmentInstiList.length > 0) {
                              ...
                              document.getElementById('<%= providerHeaderAdjustmentinstiOutputProf.ClientID %>').innerHTML = table;
                              HeaderAdjInstiClearFields();
                              BindHeaderOtherAdjustmentGroupDropdownProf();
                          }
                          else {
                              HeaderAdjInstiClearFields();
                          }
                  ...
                  error: function (jqXHR, textStatus, errorThrown) {
                      $("[id*=lblErrorMessageHeaderOtherProf]").text('no data found');
                  }
        ...
        function validateFields() {
            ...
            if ((ddlOtherPayerHealthPlanID === null || ddlOtherPayerHealthPlanID === "" || ddlOtherPayerHealthPlanID === undefined)) {
                ...
                validateField = "false";
                $("[id*=lblErrorMessageHeaderOtherProf]").text('Health plan ID is required');
                return false;

            }
            else {
                validateField = "true";
                $("[id*=lblErrorMessageHeaderOtherProf]").text('');
            }

            if ((ddlOtherPayerAdjustmentGroup === null || ddlOtherPayerAdjustmentGroup === "" || ddlOtherPayerAdjustmentGroup === undefined)) {

                validateField = "false";
                $("[id*=lblErrorMessageHeaderOtherProf]").text('Adjustment group is required');
                return false;
            ...
            if ((txtOtherPayerReasonCode === null || txtOtherPayerReasonCode === "" || txtOtherPayerReasonCode === undefined)) {
                ...
                validateField = "false";
                $("[id*=lblErrorMessageHeaderOtherProf]").text('Reason code is required');
                return false;
            ...
            if ((txtOtherPayerAmount === null || txtOtherPayerAmount === "" || txtOtherPayerAmount === undefined)) {
                ...
                validateField = "false";
                $("[id*=lblErrorMessageHeaderOtherProf]").text('Amount is required');
                return false;
            ...
            if ((txtOtherPayerQuantity !== null || txtOtherPayerQuantity !== "" || txtOtherPayerAmount !== undefined)) {
                if (txtOtherPayerQuantity.charAt(0) === "0") {
                    validateField = "false";
                    $("[id*=lblErrorMessage]").text('Invalid Quantity');
                    return false;
                }
            }
            else {
    ...
    function HeaderAdjInstiClearFields() {
        ...
        if (document.getElementById("ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerHealthPlanID").options.length >0) {
            document.getElementById("ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerHealthPlanID").options[0].selected = true;
        }
        if (document.getElementById("ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerAdjustmentGroup").options.length > 0) {
            document.getElementById("ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerAdjustmentGroup").options[0].selected = true;
        }
        $("#<%= txtOtherPayerReasonCode.ClientID %>").first().val("");
         $("#<%= txtOtherPayerAmount.ClientID %>").first().val("");
         $("#<%= txtOtherPayerQuantity.ClientID %>").first().val("");
         document.getElementById('<%= lblErrorMessageHeaderOtherProf.ClientID%>').innerHTML = '';
        $("#<%= lblErrorMessageHeaderOtherProf.ClientID %>").html("");
    ...
    function EditHeaderAdjustmentOtherPayerInfo_Prof() {
        $("[id*=lblErrorMessage]").text('');
        var claimHeaderOtherAdjustmentInstiList;
        var ddlOtherPayerHealthPlanID = $("#<%=ddlOtherPayerHealthPlanID.ClientID %> option:selected").text();
         var ddlOtherPayerAdjustmentGroup = $("#<%=ddlOtherPayerAdjustmentGroup.ClientID %> option:selected").text();
        ...
        var Claims_Header_Other_Payer_Adjustment_Information_ID = $("#<%= hdnClaims_Header_Other_Payer_Adjustment_Information_IDProf.ClientID %>").val();
        var lblErrorMessageHeaderOtherProf = $("#<%= lblErrorMessageHeaderOtherProf.ClientID %>").text();
        validateFields();
        if (validateField === "true") {
            var APIToken = $("[id*=hdnAccessToken]").val();
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result[0].lblErrorMessageHeaderOtherAdjustment) {
                        if ((hdnPlanId != ddlOtherPayerHealthPlanID) && (ddlOtherPayerAdjustmentGroup != hdnAdjustgrp) && (hdnreasoncode != txtOtherPayerReasonCode)) {
                            $("[id*=lblErrorMessage]").text(result[0].lblErrorMessageHeaderOtherAdjustment);
                        }
                        else {
                        HeaderAdjInstiClearFields();
                        document.getElementById('<%= btnOtherPayerAdjustmentInfoAdd.ClientID%>').style.visibility = "visible";
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    $("[id*=lblErrorMessageHeaderOtherProf]").text('Data not found.');
                }
            });
         }
         return false;
    ...
    function EditFieldsHeaderAdjustmentInstitutional(claim_id, Claims_Header_Other_Payer_Adjustment_Information_ID, control) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (claimHeaderOtherAdjustmentInstiList.length > 0) {
                    ...
                    for (var i = 0; i < claimHeaderOtherAdjustmentInstiList.length; i++) {
                        ...
                        ReloadAdjustmentGrouponEditClickProf(Claim_ID, HealthPlanID, AdjustmentGroup);
                        $('#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerAdjustmentGroup option:contains("' + AdjustmentGroup + '")').prop('selected', true);
                        $('#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerHealthPlanID option:contains("' + HealthPlanID + '")').prop('selected', true);
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                $("[id*=lblErrorMessageHeaderOtherProf]").text('try again..');
            }
        });
    ...
    function ddlHeaderOtherPayerHealthPlanIDProf_SelectedIndexChanged() {
        ...
        $.ajax({
            ...
            //data: '{Claim_ID: "' + Claim_ID + '",ddlHeaderOtherHealthPlanID:"' + ddlHeaderOtherHealthPlanID + '" }',
            headers: {
                "Access-Control-Allow-Origin": "*",
                "Access-Control-Allow-Methods": "POST, GET, PUT, DELETE, OPTIONS",
                "Access-Control-Allow-Headers": "Content-Type, Authorization, X-Requested-With",
            ...
            success: function (result) {
                ...
                $("#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerAdjustmentGroup").empty();
                $("#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerAdjustmentGroup").append($('<option value=""></option>'));
                for (var i = 0; i < ddAdjustmentCodeResult.length; i++) {
                    ...
                    $("#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerAdjustmentGroup").append(newOption);
                }
                $("[id*=lblErrorMessageHeaderOtherProf]").text('');
            },
            error: function (jqXHR, textStatus, errorThrown) {
                $("[id*=lblErrorMessageHeaderOtherProf]").text('try again later..');
            }
        });
    }

    function BindHeaderOtherAdjustmentGroupDropdownProf() {
        var APIToken = $("[id*=hdnAccessToken]").val();
        $.ajax({
            type: "POST",
            ...
            success: function (result) {
                ...
                for (var i = 0; i < data.length; i++) {
                    $("#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerAdjustmentGroup").append($('<option></option>').attr("value", data[i].PRIOR_AUTH_CLAIM_ADJUSTMENTGROUP_ID).text(data[i].PRIOR_AUTH_CLAIM_ADJUSTMENTGROUP_DESC));
                }
            },
            error: function (jqXHR, textStatus, errorThrown) {
            }
    ...
    function ReloadAdjustmentGrouponEditClickProf(Claim_ID, HealthPlanID, ClickedAdjustmentGroup) {
        var APIToken = $("[id*=hdnAccessToken]").val();
        $.ajax({
            type: "GET",
            ...
            success: function (result) {
                ...
                for (var i = 0; i < FilteredDropdownValues.length; i++) {
                    $("#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerAdjustmentGroup").append($('<option></option>').attr("value", FilteredDropdownValues[i].cde_adjustment_group).text(FilteredDropdownValues[i].cde_adjustment_group));
                }
                $('#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ddlOtherPayerAdjustmentGroup').find('option').filter(function () {
...
return true;
    ...
    function visibleProfReasonCode() {
        ...
        $find("mpeProfReasonCode").show();
        return false;

    }

    function CloseReasonPopupProfessional() {
        $('#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ucSubmitClaimSearchReason_txtCode').val('');
        $('#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ucSubmitClaimSearchReason_txtPlaceOfServiceName').val('');
        $('#ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_ucSubmitClaimSearchReason_gvSubmitClaimSearchPop').find('tbody').html('');
    }
    ...
    function GetHeaderAndOtherPayercode(lnk) {
        ...
        if (!(gridindexReasoncode == "")) {
           ...
           <%-- var grid = document.getElementById("<%= gvOtherPayerAdjustmentInfo.ClientID%>");--%>
            ...
            $("[id*=ctl00_MainContent_uc5SubmitClaim_ucSubmitClaimHeaderOtherPayerAdjustmentMappingProfessional_txtOtherPayerReasonCode]").val(textboxrow.cells[0].innerText.trim());
           
            return false;
        }
    }

    function visibleHeaderAndOtherPayerCodeGridView(lnk) {
        $("#<%=ucSubmitClaimSearchReason.FindControl("gvSubmitClaimSearchPop").ClientID %>").html("");
        $("#<%=ucSubmitClaimSearchReason.FindControl("txtCode").ClientID %>").val("");
        $("#<%=ucSubmitClaimSearchReason.FindControl("txtPlaceOfServiceName").ClientID %>").val("");
...
<asp:Panel ID="pnlOtherPayerAdjustmentInformation" runat="server" Style="overflow-x: hidden; height:auto; padding-top: 20px; padding-bottom: 20px;">
        ...
        <ContentTemplate>
            ...
            <div class="row" style="text-align: center; width: 97%; margin-left: 1%">
                <div class="divGrid" style="padding-right: 20px;">
                    ...
                    <div id="providerHeaderAdjustmentinstiOutputProf" runat="server"></div>
                    <%--<asp:GridView ID="gvOtherPayerAdjustmentInfo" runat="server" AllowSorting="false" CssClass="gridview"
                        ...
                        <asp:TemplateField HeaderText="Health Plan ID" >
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:HiddenField ID="hdnOtherPayerAdjustmentInfopf" Value='<%# Bind("Claims_Header_Other_Payer_Adjustment_Information_ID") %>' runat="server" />
                        ...
                        <asp:TemplateField HeaderText="Adjustment Group">
                            ...
                            <EditItemTemplate>
                                <asp:HiddenField ID="hdnAdjustgrppf" Value='<%# Bind("cde_adjustment_group") %>' runat="server" />
                        ...
                        <asp:TemplateField HeaderText="Reason Code" >
                                ...
                                <EditItemTemplate>
                                <asp:HiddenField ID="hdnreasoncodepf" Value='<%# Bind("cde_reason_code") %>' runat="server" />
                                   <asp:TextBox ID="txtHeaderreasonCode"  Text='<%# Eval("cde_reason_code")%>' runat="server" MaxLength="5"  CssClass="formFieldTextBox" Style="height: 30px; width: 100px" />
            ...
            <div runat="server" id="Searchother">
            ...
            <div class="row" style="padding-left: 70px;">
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlOtherPayerHealthPlanID" CssClass="formFieldTextBox" EnableViewState="true" runat="server"
                        AppendDataBoundItems="True" Style="height: 30px; width: 120px; min-width: 120px;" onChange="return ddlHeaderOtherPayerHealthPlanIDProf_SelectedIndexChanged()">
                    </asp:DropDownList><br />
                ...
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlOtherPayerAdjustmentGroup" CssClass="formFieldTextBox" EnableViewState="true" runat="server"
                        AppendDataBoundItems="true" Style="height: 30px; width: 100px; min-width: 100px;">
                    </asp:DropDownList><br />
                ...
                <div class="col-sm-3">
                    <asp:TextBox ID="txtOtherPayerReasonCode" runat="server" MaxLength="5" CssClass="formFieldTextBox" Style="height: 30px; width: 170px" OnChange="return ProfReasonCodetextChange()" />
                       <%-- OnTextChanged="txtOtherPayerReasonCode_TextChanged" AutoPostBack="True" />--%>
                    <%--<button id="btnOtherPayerReason" runat="server" style="display:none;" CssClass="buttonBox StepButton buttonBoxFocus" ><i class="fa fa-spinner fa-spin"></i>Loading</button>--%>
                    <asp:LinkButton ID="lnkOtherPayerReasonSearch" runat="server" ToolTip="Search" Text="Search" CausesValidation="false"
                    CommandArgument='<%# Eval("ID_PROVIDER") %>' OnClientClick="return visibleProfReasonCode()" Visible="true" style="font-size:14px;" ></asp:LinkButton>&nbsp;&nbsp;
                    <br/>
                ...
                <div class="col-sm-2">
                    <asp:TextBox ID="txtOtherPayerAmount" onkeypress="return onlyDotsAndNumbersWithNegetive(this,event);"
                        runat="server" CssClass="formFieldTextBox" MaxLength="18" Style="height: 30px; width: 200px;" /><br />
                ...
                <div class="col-sm-2">
                    <asp:TextBox ID="txtOtherPayerQuantity" onkeypress="return onlyDotsAndNumbers(this,event);"
                        runat="server" CssClass="formFieldTextBox" MaxLength="15" Style="height: 30px; width: 200px;" />
                </div>
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtOtherPayerQuantity" ValidationExpression="^[A-Za-z0-9? ,_-]+$"
                                    ErrorMessage="*" Enabled="true" SetFocusOnError="true" Text="*Invalid Input" Display="Dynamic" ForeColor="Red" />
                <div class="col-sm-1">
                    ...
                    <%--<asp:Button OnClientClick="loaderProfessionalHeaderOtherPayerDetails()" ID="btnOtherPayerAdjustmentInfoAdd" Text="Add" runat="server" CssClass="btn btn-primary" ValidationGroup="validateClaimsDental"
                        OnClick="btnOtherPayerAdjustmentInfoAdd_Click" Font-Bold="True" Width="60px" Height="30px" />--%>



                    <asp:Button ID="btnOtherPayerAdjustmentInfoAdd" Text="Add" OnClientClick="return AddButtonInstitutionalHeaderOtherAdjustmentProf();" runat="server" CssClass="btn btn-primary" ValidationGroup="validateClaimsDental" 
                         Font-Bold="True" Width="60px" Height="30px"/>
                     <asp:Button ID="btnOtherPayerAdjustmentInfoEdit" Style="visibility: hidden" Text="Update" OnClientClick="return EditHeaderAdjustmentOtherPayerInfo_Prof();" runat="server" CssClass="btn btn-primary" Font-Bold="True" ValidationGroup="vgCarePlan" Width="70px" />
            ...
            <asp:Label runat="server" CssClass="failureNotification" ID="lblErrorMessageHeaderOtherProf"> </asp:Label>
        </div>
        </ContentTemplate>
    </asp:UpdatePanel>
    <asp:HiddenField ID="hdnClaimId" runat="server" />
    <asp:HiddenField runat="server" ID="hdnClaims_Header_Other_Payer_Adjustment_Information_IDProf" />

</asp:Panel>

<ajax:ModalPopupExtender BehaviorID="mpeProfReasonCode" ID="mpeSubmitClaimSearchReason" runat="server" PopupControlID="pnlSubmitClaimSearchReason" TargetControlID="ButtonSearchReason" BackgroundCssClass="modalBackground" CancelControlID="btnCloseReason" />
<asp:Panel ID="pnlSubmitClaimSearchReason" runat="server" CssClass="modalPopup" Style="display: none; min-height: 250px; min-width: 610px; height: auto; width: auto;">
    <asp:Panel ID="pnlSubmitClaimSearchReasonHeader" CssClass="popHeader" runat="server" HorizontalAlign="Left">
        <asp:Button runat="server" ID="btnCloseReason" Text="X" Style="float: right; background-image: none; border: 0px; border-radius: 0px;" CausesValidation="false" OnClientClick="CloseReasonPopupProfessional();"/>
