<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_TransactionMonitor" Codebehind="TransactionMonitor.ascx.cs" %>
...
<div>
    ...
    <div>
                    ...
                    <ContentTemplate>--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-left">
                                <asp:TextBox ID="txtRegId" runat="server" CssClass="textEntry" TextMode="Number" Attributes="maxlength=10" Style="width: 100%" />
                            ...
                            <div class="col-sm-4 text-left">
                                <asp:TextBox ID="txtMedicaidId" runat="server" MaxLength="9" Style="width: 100%" CssClass="textEntry" />
                            </div>
                        </div>
        ...
        <cc1:groupbox id="GroupBox1" captionstyle-cssclass="bodyTextBold" style="float: left; font-weight: bold; margin-top: 40px;padding-left:20px;" horizontalalign="Center" width="30%" runat="server">
