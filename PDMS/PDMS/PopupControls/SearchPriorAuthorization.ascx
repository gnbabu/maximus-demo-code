<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_SearchPriorAuthorization" Codebehind="SearchPriorAuthorization.ascx.cs" %>
...
<div class="row col-sm-15" style="border: groove; margin-left: 10px; width: auto; height: auto">
    ...
    <asp:Panel runat="server" ID="pnlsepAuthSearch" class="CollapsingSeparator"
    ...
    <asp:Panel ID="pnlAuthSearch" runat="server" CssClass="pnl-seach" ScrollBars="Auto">
        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-lg-3 text-right">
                    <span class="ohio-field" style="font-size: 18px;text-align:right; font-weight: bold">Max Records</span>
                </div>
                <div class="col-lg-3">
                    <span style="text-align: left;">
        ...
        <div class="btnBox btnBoxCenter">
            ...
            <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" OnClientClick="return ValidatePASearch();"
                ToolTip="Search data" class="buttonBoxFocusBlue" ValidationGroup="valProviderInfoHeader" CausesValidation="True" />
            <asp:Button ID="btnClear" runat="server" Text="Clear" OnClick="btnClear_Click" OnClientClick="return btnClearAllFields_Click();" CssClass="buttonBoxFocusred"
    ...
    <asp:Panel runat="server" ID="pnlsepPasearch" class="CollapsingSeparator"
                ...
                <tr>
                    <td align="left" style="color: white">
                        <h2><span style="color: white; font-weight: bold; font-size: 25px">
                            <button type="button" class="panelHeaderStyle" tabindex="0" id="priorauthSearchResult" aria-expanded="false"
                                onclick="CollapseExpandPriorAuthSearchResult()">
                                Prior Authorization Search Result</button></span></h2>
