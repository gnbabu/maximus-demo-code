<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_ProviderManagementView" Codebehind="ProviderManagementView.ascx.cs" %>
                                  ...
                                  <asp:Panel ID="pnlEnrollmentActionLinks" runat="server">
                                    <div class="vert-links">                                        
                                        ...
                                        <div id="divOptUpdateProvider" runat="server" class="vert-links" visible="false">
                                            <asp:LinkButton ID="lnkContinueUpdateRegistration" runat="server" Text="Continue Enrollment Profile Update" CommandName="ContinueUpdateRegistration" OnClick="lnkContinueUpdateWorkflow_Click" />
                                        ...
                                        <div id="divOptODMUpdate" runat="server" class="vert-links" visible="false">
											<asp:LinkButton ID="lnkUpdateRegistration" runat="server" Text="Begin Enrollment Profile Update" CommandName="BeginUpdateRegistration" OnClick="lnkBeginUpdateWorkflow_Click" />
										</div>
                                        <div id="divOptNoActiveWorklowNonGMP" runat="server" class="vert-links" visible="false">
                                            ...
                                            <asp:LinkButton ID="lnkAddODMorODAMedSvc" runat="server" Text="Add Medicaid Services" Visible="false" OnClick="lnkAddODMorODAMedSvc_Click" />
                                        </div>
                                    ...
                                    <td style="vertical-align:top;" style="width: 100%">
                                            <div class="vert-links">
                                                ...
                                                <div id="divContinueCPCApplication" runat="server" class="vert-links" visible="false">
                                                 ...
                                                 <div id="divContinueCPCUpdate" runat="server" class="vert-links" visible="false">
                                                     <asp:LinkButton ID="lnkContinueCPCUpdate" runat="server" Text="Continue Application Update" OnClick="lnkContinueCPCApplication_Click" />
                                                 </div>
                                                 <div id="divContinueCPCContactUpdate" runat="server" class="vert-links" visible="false">
                                                     <asp:LinkButton ID="lnkContinueCPCContactUpdate" runat="server" Text="Continue Update" OnClick="lnkContinueCPCApplication_Click" />
                                                 </div>
                                                ...
                                                <div id="divContinueCMCUpdateApp" runat="server" class="vert-links" visible="false">
                                                    <asp:LinkButton ID="lnkContinueCMCUpdateApp" runat="server" Text="Continue Update" CommandName="ContinueNewRegistration" OnClick="lnkContinueCMCApplication_Click" PostBackUrl="~/Process/Registration.aspx" />
                                                </div>
        ...
        My Current and Previous Applications 
            ...
            <span class="infoContent">
                <table>
                 ...
                 <tr>
                  <td>Denied</td>
                  <td>State Medicaid has denied this application (initial applications)</td>
                 ...
                 <tr>
                  <td>Terminated</td>
                  <td>State Medicaid has denied this application resulting in a
                 ...
                 <tr>
                  <td>Suspended</td>
                  <td>The provider is suspended by Medicaid</td>
