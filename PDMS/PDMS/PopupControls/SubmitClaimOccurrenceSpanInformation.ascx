<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_SubmitClaimOccurrenceSpanInformation" Codebehind="SubmitClaimOccurrenceSpanInformation.ascx.cs" %>
