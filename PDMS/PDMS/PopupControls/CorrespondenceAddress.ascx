<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_CorrespondenceAddress" Codebehind="CorrespondenceAddress.ascx.cs" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>
<%@ Register Assembly="eWorld.UI" Namespace="eWorld.UI" TagPrefix="ew" %>
<%@ Register Src="~/UserControls/Address.ascx" TagName="Address" TagPrefix="uc" %>
<%@ Register Src="~/PopupControls/CorrespondenceAddressHistory.ascx" TagPrefix="uc" TagName="CorrespondenceAddressHistory" %>
...
<asp:ValidationSummary ID="valSumCorrespondenceAddress" DisplayMode="List" runat="server" CssClass="failureNotification" ValidationGroup="CorrespondenceAddress" />
...
<asp:Panel ID="upCorrespondenceAddressHistory" runat="server">
    ...
    <asp:Panel ID="pnlModal" runat="server" CssClass="modalPopup" Style="display: none; padding: 20px; width: 1000px;">
        ...
        <asp:Panel ID="pnlMain" runat="server" Style="margin-right: 10px">
            <div class="container-fluid" style="text-align: left; padding: 15px;">
                <div class="row">
                    <uc:CorrespondenceAddressHistory ID="ucCorrespondenceAddressHistory" runat="server" />
                </div>
                <div class="row">
...
<asp:UpdatePanel ID="upProv" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
       <div id="ParentTable" runat="server">
            <div class="row">
                <div class="col-sm-3  text-right"><asp:Label runat="server" AssociatedControlID="prov_Same" class="formLabel200">Same as Practice Location 
                    <asp:CheckBox ID="prov_Same" runat="server" CssClass="formFieldCheckBox" OnCheckedChanged="prov_Same_CheckedChanged" AutoPostBack="true" style="border:none" /></asp:Label>
                </div>
            </div>
           <div class="row">
                  <div class="col-sm-3  text-right"><asp:Label runat="server" AssociatedControlID="prov_override" class="formLabel200">Override Address Validation
            ...
            <uc:Address id="ucAddress" runat="server" ValidationGroup="CorrespondenceAddress"></uc:Address>                   
        </div>
    </ContentTemplate>
</asp:UpdatePanel>
<br />
