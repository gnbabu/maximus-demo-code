...
public partial class PopupControls_SubmitClaimSearchCCI : System.Web.UI.UserControl
{
    #region spa
   ...
   protected void LinkButton8_Click(object sender, EventArgs e)
    ...
    private DataTable GetMockData()
    {
        ...
        dt.Columns.Add(new DataColumn("ConditionCode"));
        dt.Columns.Add(new DataColumn("ConditionDesc"));

        dt.Rows.Add("AB", "Abortion Performed due to Rape");
        dt.Rows.Add("AI", "Abortion Performed due to Incest");
        return dt;
    }
}