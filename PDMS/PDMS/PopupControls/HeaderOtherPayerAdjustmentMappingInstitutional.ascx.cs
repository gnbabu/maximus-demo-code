...
public partial class PopupControls_HeaderOtherPayerAdjustmentMappingInstitutional : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            btnOtherPayerAdjustmentInfoAdd.Attributes.Add("onclick",  "DisableEnableConditionCodeAddButton();");
        }
    ...
    public void SetButtonVisibility()
    {
        ...
        {
            divHeaderOth.Visible = false;
        }
        else
        {
            divHeaderOth.Visible = true;
        }
    }
    #region spa
    ...
    public void SetOtherPayerAdjustmentInfoPanelData(List<OtherPayerAdjustmentInfo> OtherPayerAdjInfo, DataSet dsOtherPayerInfo)
    {
        ...
        if (Helper.HasRows(dsotherPayerAdjus))
        {
            ...
            providerHeaderAdjustmentinstiOutput.InnerHtml = "";
            if (otherpayerAdjusTable.Rows.Count > 0)
                ...
                foreach (DataRow dr in otherpayerAdjusTable.Rows)
                {
                    ...
                    tab = tab + "</tbody></table>";
                    providerHeaderAdjustmentinstiOutput.InnerHtml = tab;
                }
            else { providerHeaderAdjustmentinstiOutput.InnerHtml = ""; }
    ...
    //{
    //    lblErrorMessageHeaderOtherAdjustment.Text = "";
    //    if (Page.IsValid)
    //    {
    //        if (!string.IsNullOrEmpty(hdnClaimId.Value))
    //        {
    //            lblErrorMessageHeaderOtherAdjustment.Text = string.Empty;
    ...
    //                    {
    //                        lblErrorMessageHeaderOtherAdjustment.Text = "Same reason code cannot be reported multiple times with same adjustment group for the same payer. ";
    //                        return;
    //                    }
    //                }
    ...
    //                    if (samepayer == 6)
    //                    {
    //                        lblErrorMessageHeaderOtherAdjustment.Text = "Each adjustment group can be repeated up to 6 times for one other payer";
    //                        return;
    //                    }
    ...
    //                else
    //                {
    //                    lblErrorMessageHeaderOtherAdjustment.Text = "Invalid Reason Code";
    //                    return;
    //                }
    //            }
    //            Dictionary<string, string> parms = new Dictionary<string, string>();
    //            parms.Add("Claim_id", hdnClaimId.Value);
    //            if (!string.IsNullOrEmpty(//}ddlOtherPayerHealthPlanID.SelectedValue))
    //            {
    ...
    //        parms.Add("Health_Plan_ID", ddlOtherPayerHealthPlanID.SelectedItem.Text);
    //        parms.Add("Adjustment_Group", ddlOtherPayerAdjustmentGroup.SelectedItem.Text);
    //        parms.Add("Reason_Code", string.IsNullOrEmpty(txtHeaderreasonCode.Text) ? null : txtHeaderreasonCode.Text);
    ...
    //            _spa = new PDMSService.PDMSServiceClient();
    //        }
    //        _spa.UpdatePanelsData("claims_header_other_payer_adjustment_information", parms);
    //        List<OtherPayerAdjustmentInfo> listData = new List<OtherPayerAdjustmentInfo>();
    //        gvOtherPayerAdjustmentInfo.EditIndex = -1;
    //        this.SetOtherPayerAdjustmentInfoPanelData(listData, null);
    //    }
    ...
    //    _spa.DeletePanelsData("claims_header_other_payer_adjustment_information", "Claims_Header_Other_Payer_Adjustment_Information_ID", Convert.ToInt32(hdnOtherPayerAdjustmentInfo.Value));
    //    SetOtherPayerAdjustmentInfoPanelData(listData, null);
    //}
    ...
    //    DropDownList ddlOtherPayerAdjustmentGroup = (DropDownList)gvOtherPayerAdjustmentInfo.Rows[e.RowIndex].FindControl("ddlOtherPayerAdjustmentGroup");
    //    TextBox txtHeaderreasonCode = (TextBox)gvOtherPayerAdjustmentInfo.Rows[e.RowIndex].FindControl("txtHeaderreasonCode");
    //    HiddenField hdnreasoncode = (HiddenField)gvOtherPayerAdjustmentInfo.Rows[e.RowIndex].FindControl("hdnreasoncodeIns");
    //    HiddenField hdnAdjustgrp = (HiddenField)gvOtherPayerAdjustmentInfo.Rows[e.RowIndex].FindControl("hdnAdjustgrpIsn");
    //    HiddenField hdnOtherPayerAdjustmentInfo = (HiddenField)gvOtherPayerAdjustmentInfo.Rows[e.RowIndex].FindControl("hdnOtherPayerAdjustmentInfoIns");
    ...
    {
        _spa = new PDMSService.PDMSServiceClient();
        _spa.DeletePanelsData("claims_header_other_payer_adjustment_information", "Claims_Header_Other_Payer_Adjustment_Information_ID", Convert.ToInt32(Id));
    }
    ...
    //    gvOtherPayerAdjustmentInfo.EditIndex = e.NewEditIndex;
    //    List<OtherPayerAdjustmentInfo> listData = new List<OtherPayerAdjustmentInfo>();
    //    SetOtherPayerAdjustmentInfoPanelData(listData, null); gvOtherPayerAdjustmentInfo
    //}
