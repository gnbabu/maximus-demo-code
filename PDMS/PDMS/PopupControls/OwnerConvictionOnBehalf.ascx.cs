...
public partial class PopupControls_OwnerConvictionOnBehalf : BasePopupControl
{
    ...
    public override void LoadData(DataRow dr)
    {
        ...
        if (dr != null)
        {
            hdnRegOwnerConvictionOnBehalfID.Value = Helper.GetString("REG_OWNER_CONVICTION_ON_BEHALF_ID", dr);
    ...
    public void SaveData()
    {
        ...
        PDMSService.PDMSServiceClient psc = new PDMSService.PDMSServiceClient();
        if (!string.IsNullOrEmpty(hdnRegOwnerConvictionOnBehalfID.Value))
        {
            // Update
            parms.Add("REG_OWNER_CONVICTION_ON_BEHALF_ID", hdnRegOwnerConvictionOnBehalfID.Value);
            psc.UpdateRegistrationDataTable("OWNER_CONVICTION_ON_BEHALF", parms);
        }
        else
        {
            // Insert
            
            psc.InsertRegistrationDataTable("OWNER_CONVICTION_ON_BEHALF", parms);
        }
    }
    ...
    public void SetOwnerConvictionOnBehalf(DataSet ds)
    {
        //;
    }
}