<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_PriorAuthDentalHSCPSCodeSearch" Codebehind="PriorAuthDentalHSCPSCodeSearch.ascx.cs" %>
...
<div class="row" style="text-align: center;">
    <div class="col-sm-6 col-md-4 col-lg-3 ">
        <span class="ohio-field-label"> <b>HCPCS Code</b>
...
<mms:SortablePagingGridView
    ID="gvHSCPSCodeSearch"
    runat="server"
    AutoGenerateColumns="False"
    CssClass="gridViewSmallFont" Width="100%"
    AllowSorting="true"
    EmptyDataText="No Providers found."
    OnPageIndexChanging="gvHSCPSCodeSearch_PageIndexChanging"
    OnSorting="gvHSCPSCodeSearch_Sorting"
    RowStyle-VerticalAlign="Top"
    AllowPaging="True"
    PageSize="15"
    GridViewSortColumn="HCPCS Code" GridViewSortDirection="Ascending"
    DataKeyNames="MedicaidID, BusinessLastName,FirstName">
    <Columns>

        <asp:BoundField DataField="HCPCS Code" HeaderText="HCPCS Code" SortExpression="HCPCS Code" />
