<%@ Control Language="C#" AutoEventWireup="true" Inherits="PopupControls_SatellitePracticeLocationsHistory" Codebehind="SatellitePracticeLocationsHistory.ascx.cs" %>
<br />
<asp:GridView runat="server" ID="grd" AutoGenerateColumns="False" HorizontalAlign="Left" CssClass="gridview" EmptyDataText="No records found" 
