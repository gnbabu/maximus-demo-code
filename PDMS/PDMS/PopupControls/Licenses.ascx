<%@ control language="C#" autoeventwireup="true" inherits="PopupControls_Licenses" Codebehind="Licenses.ascx.cs" %>
    ...
    <div id="divProfessionalLicense" style="width: 100%; margin-left: 10%;">
        <div id="ParentTable" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <asp:textbox id="prov_Number" runat="server" cssclass="formField" maxlength="25" aria-Label="License Number" aria-required="true" ontextchanged="prov_Number_TextChanged" autopostback="true"/>
