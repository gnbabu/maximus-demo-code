<%@ Control Language="C#" AutoEventWireup="true" Inherits="Maintenance_FormField" Codebehind="FormField.ascx.cs" %>
...
<div id="divFieldComboBox" runat="server" style="display:none">
    <table class="fieldTable">
        <tr>
            ...
            <td><asp:DropDownList ID="fieldComboBox" AutoPostBack="false" AppendDataBoundItems="True" runat="server"></asp:DropDownList></td>
        </tr>
    </table>
</div>
