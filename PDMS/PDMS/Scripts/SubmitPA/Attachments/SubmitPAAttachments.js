var validFileExtensions = "doc,docx,pdf,xls,XLS,xlsm,xlsx,ppt,pptx,mdi,jpe,txt,jpg,jpeg,png,gif,bmp,tif,tiff,pi,ec,csv,xlsm,msg,acrbak";
...
async function validateDentalFileAndUploadToS3(isDental) {
    ...
    if (destinationPayerID == null || (typeof destinationPayerID === 'string' && destinationPayerID.trim().length === 0)) {
            
        destinationPayerID = "MMISODJFS";
        }
