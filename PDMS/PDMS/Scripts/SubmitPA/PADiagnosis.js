    ...
    if (txtDiagnosisCode != '' && txtDiagnosisCode != null && txtDiagnosisCode != undefined && isvalidDiagCode) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                else if (result.length > 1 && isRowSelected == false) {
...
function AddNewdiagnosisLineItem(code, index) {
    ...
    document.getElementById('ctl00_MainContent_uc1SubmitPriorAuthorization_lblIcdVersionError').innerHTML = '';
    document.getElementById('ctl00_MainContent_uc1SubmitPriorAuthorization_lblIcdVersionError').style.visibility = "none";
