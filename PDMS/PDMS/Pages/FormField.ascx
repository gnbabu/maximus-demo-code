<%@ Control Language="C#" AutoEventWireup="true" Inherits="Pages_FormField" Codebehind="FormField.ascx.cs" %>
...
<div id="divFieldComboBox" runat="server" style="display:none">
    <table class="fieldTable">
        <tr>
            ...
            <td><asp:DropDownList ID="fieldComboBox" AutoPostBack="false" runat="server"></asp:DropDownList></td>
        </tr>
    </table>
</div>
...
<div id="divFieldRadioButtonList" runat="server" style="display:none">
    <table class="fieldTable">
        <tr>
            <td><asp:Label AssociatedControlID="fieldRadioButtonList" ID="lblRadioButtonList" runat="server" CssClass="formLabel300"/></td>
