...
{
    public class HomeOfficeAddressPresenter : PresenterBase, IPresenter<IHomeOfficeAddressView, Address>
    {
	    private IHomeOfficeAddressView view = null;
	    ...
	    #endregion
        public HomeOfficeAddressPresenter(IHomeOfficeAddressView view)
	    {
