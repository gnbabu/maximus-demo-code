...
{
    public class PrimaryContactPresenter : PresenterBase, IPresenter<IPrimaryContactView, Address>
	{
		private IPrimaryContactView view = null;
		...
		public PrimaryContactPresenter(IPrimaryContactView view)
		{
