...
{
	public class OtherAddressPresenter : PresenterBase, IPresenter<IOtherAddressView, Address>
	{
		private IOtherAddressView view = null;
		...
		public OtherAddressPresenter(IOtherAddressView view)
		{
