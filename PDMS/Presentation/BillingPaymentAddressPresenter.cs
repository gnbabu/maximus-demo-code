...
{
    public class BillingPaymentAddressPresenter : PresenterBase, IPresenter<IBillingPaymentAddressView, Address>
    {
	    private IBillingPaymentAddressView view = null;
	    ...
	    public BillingPaymentAddressPresenter(IBillingPaymentAddressView view)
	    {
