...
{
    public class HospitalAddressPresenter :PresenterBase, IPresenter<IHospitalAddressView, Address>
    {
	    private IHospitalAddressView view = null;
	    ...
	    public HospitalAddressPresenter(IHospitalAddressView view)
	    {
