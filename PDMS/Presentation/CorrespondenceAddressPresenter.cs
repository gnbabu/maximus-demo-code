...
{
    public class CorrespondenceAddressPresenter : PresenterBase, IPresenter<ICorrespondenceAddressView, Address>
	{
		private ICorrespondenceAddressView view = null;
		...
		public CorrespondenceAddressPresenter(ICorrespondenceAddressView view)
		{
