<%@ control language="C#" autoeventwireup="true" inherits="PopupControls_ClaimSearch, App_Web_glma3lal" %>
...
<span id="errorMessageclaimsearch" role="alert" aria-live="assertive"><asp:ValidationSummary ID="valerrormess" DisplayMode="List" runat="server" CssClass="failureNotification" ValidationGroup="ClaimSearch" /></span>
...
<div class="row" style="border: groove; margin-left: 10px">
    ...
    <cc1:GroupBox ID="gbClaimSearch" Caption="CLAIM SEARCH" CaptionStyle-CssClass="bodyTextBold" HorizontalAlign="Center" runat="server" CaptionStyle-BackColor="#0099cc" CaptionStyle-ForeColor="White" CaptionStyle-Font-Bold="true">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-3" style="margin-left: 40px;">
                            <asp:Button ID="btnSearch" runat="server" Style="background-color: #4a7b4d !important;" Text="Search" CssClass="btn btn-success" OnClick="btnSearch_Click" ValidationGroup="ClaimSearch"
                                ToolTip="Search data" CausesValidation="true" Width="90px" OnClientClick="return btnSearch_Click();" />

                            <asp:Button ID="btnClear" runat="server" CausesValidation="false" Style="background-color: #d03a3a !important;" Text="Clear" CssClass="btn btn-danger" OnClick="btnClear_Click" Width="90px" />
    ...
    <cc1:GroupBox ID="gbSearchResult" Caption="CLAIM SEARCH RESULT" CaptionStyle-CssClass="bodyTextBold" HorizontalAlign="Center" runat="server" CaptionStyle-ForeColor="White" CaptionStyle-BackColor="#0099cc" Font-Bold="true">
