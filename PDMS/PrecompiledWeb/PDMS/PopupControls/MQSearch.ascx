<%@ control language="C#" autoeventwireup="true" inherits="UserControls_MQSearch, App_Web_av5ll3zk" %>
        ...
        <asp:Panel ID="pnlFilter" runat="server" DefaultButton="btnSearch">
            <div style="width: 100%;" class="table">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 text-left">
                        <asp:TextBox ID="txtFromDate" runat="server" CssClass="formField formField" /><ajax:CalendarExtender ID="CalendarExtender1" TargetControlID="txtFromDate" runat="server" />
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <asp:TextBox ID="txtToDate" runat="server" CssClass="formField formField" /><ajax:CalendarExtender ID="CalendarExtender2" TargetControlID="txtToDate" runat="server" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-2 text-right">
