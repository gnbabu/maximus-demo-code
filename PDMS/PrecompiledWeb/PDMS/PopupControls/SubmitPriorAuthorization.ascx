<%@ control language="C#" autoeventwireup="true" inherits="PopupControls_SubmitPriorAuthorization, App_Web_tiu3g34i" %>
...
<div class="row">
    ...
    <div class="col-sm-6" style="display: flex; align-content: flex-end; justify-content: flex-end; align-items: flex-end; flex-wrap: wrap;">
        <div style="text-align: center; margin-top: 20px; width: 400px">
            ...
            <asp:RadioButtonList ID="rblClaimType" CssClass="radioButtonList rblClaimType" aria-label="Prior Authorization Type"
                ...
                OnSelectedIndexChanged="rblClaimType_SelectedIndexChanged" Width="390px" RepeatLayout="Table" Style="background: none;">
    ...
    <div class="row col-sm-15" style="border: groove;">
        ...
        <asp:UpdatePanel ID="upRecipientInfo" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel runat="server" ID="pnlsepRecipient" class="CollapsingSeparator" Style="background-color: #2297bc"
                    CssClass="OwnerRecipientInformation">
        ...
        <div id="DivPriorAuth" runat="server">
            ...
            <asp:Panel runat="server" ID="pnlSepContact" class="CollapsingSeparator" Style="background-color: #2297bc" CssClass="OwnerContactInfo">
            ...
            <asp:Panel runat="server" ID="pnlsepServiceInformation" class="CollapsingSeparator" Style="background-color: #2297bc" CssClass="OwnerRecipientInformation">
                                    ...
                                    <div class="row" style="display: inline-flex;">
                                        ...
                                        <div class="col-sm-4 text-center">
                                            <span style="font-size: 15px;">
                                                <asp:LinkButton ID="lnkplaceofservicesrch" runat="server" Text="Search" OnClientClick="return visiblePlaceOfServiceDetails()" />
                                            </span>
                                        </div>
                                    </div>
                                </ContentTemplate>
            ...
            <asp:Panel runat="server" ID="pnlSepTrackingNumber" class="CollapsingSeparator" Style="background-color: #2297bc" CssClass="OwnerTrackingNumber">
            ...
            <asp:UpdatePanel ID="UpdatePanelSP" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel runat="server" ID="pnlSepService" class="CollapsingSeparator" Style="background-color: #2297bc" CssClass="OwnerSERVICE">
            ...
            <asp:UpdatePanel ID="UpdatePanelOPI" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel runat="server" ID="pnlseporderproviderinfo" class="CollapsingSeparator" Style="background-color: #2297bc" CssClass="OwnerOrderProviderInfo">
            ...
            <asp:Panel ID="uptPnlDiagnosis" runat="server">
                ...
                <asp:Panel runat="server" ID="pnlsepDiagnosis" class="CollapsingSeparator"
                    Style="background-color: #2297bc; height: auto" CssClass="OwnerOrderProviderInfo">
            ...
            <asp:Panel ID="uptPnlServiceDetails" runat="server">
                ...
                <asp:Panel runat="server" ID="pnlsepServiceDetail" class="CollapsingSeparator"
                    Style="background-color: #2297bc" CssClass="OwnerServiceDetailDental">
            ...
            <asp:Panel ID="upDentalServiceDetail" runat="server">
                ...
                <asp:Panel runat="server" ID="pnlsepDentalServiceDetail" class="CollapsingSeparator"
                    Style="background-color: #2297bc"
                    CssClass="OwnerServiceDetailDental">
            ...
            <asp:Panel ID="upProfessionalServiceDetail" runat="server">
                ...
                <asp:Panel runat="server" ID="pnlsepProfessionalServiceDetail" class="CollapsingSeparator"
                    Style="background-color: #2297bc"
                    CssClass="OwnerServiceDetail">
            ...
            <asp:Panel runat="server" ID="pnlsepCertHospital" class="CollapsingSeparator"
                Visible="false" Style="background-color: cornflowerblue;" CssClass="OwnerServiceDetail">
            ...
            <asp:Panel runat="server" ID="pnlsepProvidersNotes" class="CollapsingSeparator"
                Style="background-color: #2297bc" CssClass="OwnerProviderNote">
            ...
            <asp:Panel runat="server" ID="pnlReviewerNotes" class="CollapsingSeparator" Style="background-color: #2297bc">
            ...
            <asp:Panel runat="server" ID="pnlsepOutcomeofReview" class="CollapsingSeparator"
                Style="background-color: #2297bc" CssClass="OwnerProviderNote">
            ...
            <asp:Panel runat="server" ID="pnlSepAttachment" class="CollapsingSeparator"
                Style="background-color: #2297bc" CssClass="OwnerAttachment">
            ...
            <asp:Panel runat="server" ID="pnlSepDentalAttachment" class="CollapsingSeparator"
                Style="background-color: #2297bc" CssClass="OwnerAttachment">
            ...
            <asp:Panel runat="server" ID="pnlSepmissingtooth" class="CollapsingSeparator" Visible="false"
                Style="background-color: #2297bc" CssClass="Ownermissingtooth">
            ...
            <asp:Panel runat="server" ID="pnlSepDocumentbyMail" class="CollapsingSeparator"
                Style="background-color: #2297bc" CssClass="OwnerDocumentbyMail">
            ...
            <asp:Panel ID="pnlreviewernoteprovider" runat="server" Style="min-height: 100px; min-width: 150px; height: auto; width: auto; max-width: 1200px;">
                <div class="divGrid" style="padding-top: 10px">
                ...
                <div style="text-align: center; padding-top: 4px; display: inline-flex; width: 100%;">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <asp:Button ID="btnSave" runat="server" CausesValidation="true" Style="margin: 0 2px;" Text="Save" CssClass="buttonBoxFocus"
