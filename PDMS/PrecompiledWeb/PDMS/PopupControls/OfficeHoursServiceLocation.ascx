<%@ control language="C#" autoeventwireup="true" inherits="PopupControls_OfficeHoursServiceLocation, App_Web_rqhgepvh" %>
    ...
    <ContentTemplate>
        ...
        <div id="ParentTable" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlMonStartTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Monday StartTime" RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
                <div class="col-sm-1">
                </div>
                <div class="col-sm-3">
                     <asp:DropDownList ID="ddlMonEndTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Monday EndTime" RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
                <div class="col-sm-2">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlTueStartTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Tuesday StartTime" RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
                <div class="col-sm-1">
                </div>
                <div class="col-sm-3">
                    <asp:DropDownList ID="ddlTueEndTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Tuesday EndTime" RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
               <div class="col-sm-2">
                    <span class="formLabel200 noWrap">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlWedStartTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Wednesday StartTime" RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
                <div class="col-sm-1">
                </div>
                <div class="col-sm-3">
                     <asp:DropDownList ID="ddlWedEndTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Wednesday EndTime" RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
               <div class="col-sm-2">
                    <span class="formLabel200 noWrap">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlThuStartTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Thursday StartTime"  RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
                <div class="col-sm-1">
                </div>
                <div class="col-sm-3">
                     <asp:DropDownList ID="ddlThuEndTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Thursday EndTime"  RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
               <div class="col-sm-2">
                    <span class="formLabel200 noWrap">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlFriStartTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Friday StartTime" RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
                <div class="col-sm-1">
                </div>
                <div class="col-sm-3">
                     <asp:DropDownList ID="ddlFriEndTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Friday EndTime" RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
               <div class="col-sm-2">
                    <span class="formLabel200 noWrap">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlSatStartTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Saturday StartTime" RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
                <div class="col-sm-1">
                </div>
                <div class="col-sm-3">
                     <asp:DropDownList ID="ddlSatEndTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Saturday EndTime"  RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
               <div class="col-sm-2">
                    <span class="formLabel200 noWrap">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <asp:DropDownList ID="ddlSunStartTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Sunday StartTime" RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
                <div class="col-sm-1">
                </div>
                <div class="col-sm-3">
                     <asp:DropDownList ID="ddlSunEndTime" runat="server" CssClass="formDropDown dynamicDDWidth" aria-label="Sunday EndTime"  RepeatDirection="Horizontal">
                    </asp:DropDownList>
                </div>
               <div class="col-sm-2">
                    <span class="formLabel200 noWrap">
