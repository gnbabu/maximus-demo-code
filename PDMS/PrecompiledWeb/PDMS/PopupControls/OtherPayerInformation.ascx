<%@ control language="C#" autoeventwireup="true" inherits="UserControls_OtherPayerInformation, App_Web_2k5drnu4" %>
...
<asp:Panel runat="server" ID="pnlsepOtherPayerInformation" class="CollapsingSeparator"
    ...
    ToolTip="Click to Expand/Collapse" CssClass="OwnerToothQuadrantInfo">
