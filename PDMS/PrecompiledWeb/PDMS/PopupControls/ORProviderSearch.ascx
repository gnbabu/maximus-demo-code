<%@ control language="C#" autoeventwireup="true" inherits="PopupControls_ORProviderSearch, App_Web_l5y5araq" %>
    ...
    <div class="content cForm" style="padding-top: 15px">
        ...
        <div class="row">
            <div class="row-centered col-lg-12" style="padding-top: 30px; text-align: center; padding-bottom: 10px;">
                <button id="btnSearch" type="button" class="btn btn-primary margin-right-n btn-success mebtn" style="background-color: #286090 !important; min-width: 200px;" onclick="makeORPSearch()">Search</button>
                <button id="btnclear" type="button" class="btn btn-default margin-right-n btn-danger clearme" style="background-color: #d03a3a !important; min-width: 200px;" onclick="makeclear()">Clear</button>
            </div>
        </div>
    </div>
</div>
