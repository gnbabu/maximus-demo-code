<%@ control language="C#" autoeventwireup="true" inherits="PopupControls_RecipientEligibilitySearch, App_Web_c4une0e1" %>
...
<div class="row col-sm-15" style="border: groove; margin-left: 10px">
    ...
    <asp:Panel runat="server" ID="pnlsepEligbilitysearch" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerEligbilitysearch">
...
<%--                    <span class="ohio-field" style="font-size: 15px; text-align: right">Procedure Code</span>--%>
        ...
        <div class="col-md-12 text-right">
            <asp:Button ID="btnSearch" runat="server" CausesValidation="true" Text="Search" CssClass="buttonBoxFocus" OnClick="btnSearch_Click" ValidationGroup="valRetrieveReports" ToolTip="Search" />
            <asp:Button ID="btnClear" runat="server" CausesValidation="false" Text="Clear" CssClass="buttonBox" OnClick="btnClear_Click" ToolTip="Clear" />
        </div>        
    ...
    <asp:Panel runat="server" ID="pnlsepRecipientInfo" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerRecipientInfo">
    ...
    <asp:Panel runat="server" ID="pnlsepBenefitsassplan" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc" ToolTip="Click to Expand/Collapse" CssClass="OwnerBenefitsassplan">
       <h3><asp:label runat="server" ID="lblcpebenfitassplan" CssClass="pageHeader ph2">-</asp:label><span id="sepBenefitsassplan" runat="server" class="pageHeader ph2"><button type="button" class="panelHeaderStyleEligbilitysearch" tabindex="0" id="benfitassplan" aria-expanded="true" onclick="BenfitAssignmentPlan()"> BENEFIT/ASSIGNMENT PLAN(S)</button></span></h3></asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlsepManagedCarePlan" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerManagedCarePlan">
    
       <h4><asp:label runat="server" ID="lblcpemangcareplan" CssClass="pageHeader ph2">-</asp:label><span id="sepManagedCarePlan" runat="server" class="pageHeader ph2"><button type="button" class="panelHeaderStyleEligbilitysearch" tabindex="0" id="managedcareplan" aria-expanded="true" onclick="ManagedCarePlan()"> MANAGED CARE PLANS</button></span></h4></asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlsepThirdPartyInsurance" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerThirdPartyInsurance">
       
       <h5><asp:label runat="server" ID="lblcpethirdpartyliab" CssClass="pageHeader ph2">-</asp:label><span id="sepThirdPartyInsurance" runat="server" class="pageHeader ph2"><button type="button" class="panelHeaderStyleEligbilitysearch" tabindex="0" id="thirdpartyliability" aria-expanded="true" onclick="ThirdPartyLiability()"> THIRD PARTY LIABILITY</button></span></h5></asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlsepPatientLiability" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerPatientLiability">
        <asp:label runat="server" ID="lblcpepatientliab" CssClass="pageHeader ph2">-</asp:label><span id="sepPatientLiability" runat="server" class="pageHeader ph2"><button type="button" class="panelHeaderStyleEligbilitysearch" tabindex="0" id="patientliability" aria-expanded="true" onclick="PatientLiability()"> PATIENT LIABILITY</button></span></asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlsepLongTermCareFacilityPlacements" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerLongTermCareFacilityPlacements">
    ...
    <asp:Panel runat="server" ID="pnlsepLockin" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerLockin">
         <asp:label runat="server" ID="lblcpelockin" CssClass="pageHeader ph2">-</asp:label><span id="sepLockin" runat="server" class="pageHeader ph2"><button type="button" class="panelHeaderStyleEligbilitysearch" tabindex="0" id="lockin" aria-expanded="true" onclick="LockIn()">LOCK IN</button></span></asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlsepMedicare" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerMedicare">
        <asp:label runat="server" ID="lblcpemedicare" CssClass="pageHeader ph2">-</asp:label><span id="sepMedicare" runat="server" class="pageHeader ph2"><button type="button" class="panelHeaderStyleEligbilitysearch" tabindex="0" id="medicare" aria-expanded="true" onclick="Medicare()"> MEDICARE </button></span></asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlsepLevelofCareDetermination" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerLevelofCareDetermination">
        <asp:label runat="server" ID="lblcpelevelcaredeter" CssClass="pageHeader ph2">-</asp:label><span id="sepLevelofCareDetermination" runat="server" class="pageHeader ph2"><button type="button" class="panelHeaderStyleEligbilitysearch" tabindex="0" id="levelofcaredetermination" aria-expanded="true" onclick="LevelOfCareDetermination()">LEVEL OF CARE DETERMINATION</button></span></asp:Panel>
...
<%--            <div class="col-sm-1">
    ...
    <asp:Panel runat="server" ID="pnlsepRestrictedCoverage" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerRestrictedCoverage">
        <asp:label runat="server" ID="lblcperestrictedcoverage" CssClass="pageHeader ph2">-</asp:label><span id="sepRestrictedCoverage" runat="server" class="pageHeader ph2"><button type="button" class="panelHeaderStyleEligbilitysearch" tabindex="0" id="restrictedcoverage" aria-expanded="true" onclick="RestrictedCoverage()"> RESTRICTED COVERAGE</button></span></asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlsepAssociatedChildren" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerAssociatedChildren">
        <asp:label runat="server" ID="lblcpeassociatedchild" CssClass="pageHeader ph2">-</asp:label><span id="sepAssociatedChildren" runat="server" class="pageHeader ph2"><button type="button" class="panelHeaderStyleEligbilitysearch" tabindex="0" id="associatedchild" aria-expanded="true" onclick="AssociatedChild()"> ASSOCIATED CHILD(REN)</button></span></asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlsepSpecialProgram" class="CollapsingSeparator" Visible="false" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc;" ToolTip="Click to Expand/Collapse" CssClass="OwnerSpecialProgram">
        <span id="sepSpecialProgram" runat="server" class="pageHeader ph2">- SPECIAL PROGRAM</span> </asp:Panel>
