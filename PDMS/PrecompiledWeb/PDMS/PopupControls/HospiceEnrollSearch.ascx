<%@ control language="C#" autoeventwireup="true" inherits="PopupControls_HospiceEnrollSearch, App_Web_tuludzhv" %>
...
<asp:Panel ID="pnlHospiceSearch" runat="server">
    <cc1:GroupBox ID="gbSearch"  HorizontalAlign="Center" Width="100%" runat="server">
        <h1>HOSPICE ENROLLMENT SEARCH</h1>
            ...
            <asp:Panel ID="pnlFilter" runat="server" DefaultButton="btnSearch">
                <div class="container-fluid">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        ...
                        <ContentTemplate>
                            <br /><br />
                            <asp:Button ID="btnSearch" runat="server" CausesValidation="true" Text="Search" CssClass="buttonBoxFocus" OnClick="btnSearch_Click" Style="background-color:  #288128 !important" />
                            <asp:Button ID="btnClear" runat="server" CausesValidation="false" Text="Clear" CssClass="buttonBox" OnClick="btnClear_Click" Style="background-color: #D03A3A !important" />
                            <asp:Button ID="btnAdd" runat="server" CausesValidation="false" Text="Add" Enabled="false" CssClass="buttonBox" Style="background-color: dodgerblue !important" />
