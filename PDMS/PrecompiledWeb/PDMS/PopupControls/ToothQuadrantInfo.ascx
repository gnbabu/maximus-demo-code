<%@ control language="C#" autoeventwireup="true" inherits="UserControls_ToothQuadrantInfo, App_Web_av5ll3zk" %>
...
<asp:UpdatePanel ID="updatePanelToothQuadrant" runat="server"  UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:Panel runat="server" ID="pnlsepToothQuadrantInfo" class="CollapsingSeparator" onclick="javascript:CollapseExpand(this);" Style="background-color: #2297bc" ToolTip="Click to Expand/Collapse" 
            CssClass="OwnerToothQuadrantInfo">
