<%@ control language="C#" autoeventwireup="true" inherits="UserControls_ScreeningResult, App_Web_rqhgepvh" %>
...
<div id="divScreeningResults" class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-5 text-left"><asp:DropDownList runat="server" ID="ddlMatchResults" CssClass="formDropDown wd250"></asp:DropDownList></div>
        <div class="col-sm-3">
