<%@ control language="C#" autoeventwireup="true" inherits="PopupControls_Specialties, App_Web_wbqq1lcm" enableviewstate="true" %>
                    ...
                    <ContentTemplate>
                        <table id="ParentTable" runat="server">
                            ...
                            <tr>
                                <td></td>
                                <td align="left">
                                    <asp:Label ID="lblPrimaryMessage" CssClass="failureNotification" runat="server" Text="" />
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList aria-label="Select SpecialtyDropdown" ID="ddlSpecialty" runat="server" EnableViewState="true" onchange="specialityChange(this)"
                                        OnSelectedIndexChanged="ddlSpeciality_Changed" AutoPostBack="true">
                                    </asp:DropDownList>
