<%@ control language="C#" autoeventwireup="true" inherits="PopupControls_SearchClaims, App_Web_c4une0e1" %>
...
<div class="cformContainer active">
    ...
    <div class="row cForm">
        ...
        <div class="col-lg-12 text-center" style="padding: 28px 0 10px 0">
            <button id="btnSearch" type="button" onclick="btnSearch_Click()" style="background-color: #4a7b4d !important;" class="btn btn-success claimbtn">Search</button>
            <button id="btnClear" type="button" onclick="clearForm()" style="background-color: #d03a3a !important;" class="btn btn-danger claimbtn clearclaim">Clear</button>
