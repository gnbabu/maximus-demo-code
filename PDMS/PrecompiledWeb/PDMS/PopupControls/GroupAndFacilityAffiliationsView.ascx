<%@ control language="C#" autoeventwireup="true" inherits="Pages_GroupAndFacilityAffiliationsView, App_Web_guw1elnn" %>
...
<script>
    function GoToHistory(event, redirectionType) {
        ...
        if (redirectionType == 'hospital') {
            redirectionUrl = urlpath + "/HospitalAffiliationHistoryDetails.aspx?regId=" + regId;
        }
        if (redirectionType == 'group') {
            redirectionUrl = urlpath + "/GroupAffiliationHistoryDetails.aspx?regId=" + regId;
        }
        if (redirectionType == 'credentialeddelegate') {
            redirectionUrl = urlpath + "/CredentialingDelegatesHistoryDetails.aspx?regId=" + regId;
        }
