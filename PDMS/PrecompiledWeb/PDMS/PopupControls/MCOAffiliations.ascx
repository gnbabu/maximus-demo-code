<%@ control language="C#" autoeventwireup="true" inherits="Pages_MCOAffiliations, App_Web_wenzyumt" %>
    ...
    <ContentTemplate>
        <div id="ParentTable" runat="server">
            <div class="row" id="trDateOccurence">
                <div class="col-sm-8"><span class="formLabel200">Are you interested in contracting with any of the Ohio Medicaid Managed Care Plans?</span></div>
        ...
        <div id="divplans" runat="server">
            <div class="row" id="trPossParticipation">
                ...
                <div class="col-sm-12"><span class="formLabel200">Indicate your interested in possible participation with one or more Ohio Medicaid Managed Care Plans</span></div>
        ...
        <div id="AffiliationInfo">
            ...
            <p id="paraVerifyIndividual" runat="server" visible="true">
                <b>Please Note: </b>
                <span style="color: #de2316;">This indication does not ensure a contract with the Ohio Medicaid Managed Care Plans. Providers must still go thru the plan’s contracting process, if applicable</span>
                <br />
