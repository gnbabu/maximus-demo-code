<%@ page language="C#" autoeventwireup="true" masterpagefile="~/MasterPage.master" inherits="Process_WorkHistoryDetails, App_Web_14kfymdt" enableEventValidation="false" stylesheettheme="Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script>
        const columns = [
            ...
            { key: 'LAST_MODIFIED_DATE_TIME', title: 'Update Date', type: 'date' }
        ];
    ...
    <div class="container-fluid" style="min-height: 300px;">
        ...
        <div class="whModalHeader">
            <h3 class="m-0"><strong>Work History</strong> </h3>
        ...
        <div class="footerBtn text-right" style="margin-top: 6px;">
            <div class="btn-group" role="group">
                ...
                <%--<input id="whOk" type="button" class="btn btn-info" style="width: 100px;" value="Ok" onclick="history.back()" />--%>
