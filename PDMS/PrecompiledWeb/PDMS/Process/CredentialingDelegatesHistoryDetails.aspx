<%@ page language="C#" autoeventwireup="true" masterpagefile="~/MasterPage.master" inherits="Process_AffiliationHistoryDetails, App_Web_rnw0hezi" enableEventValidation="false" stylesheettheme="Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script>
        ...
        function fetchDataFromApi() {
            ...
            $.ajax({
                type: "GET",
                url: webApiEnrollment + "GetCredentalingDelegatesHistoryData?regId=" + regId,
                async: false,
                headers: {
