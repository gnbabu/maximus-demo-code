<%@ control language="C#" autoeventwireup="true" inherits="UserControls_SelfServiceProgressBar, App_Web_p4ixifjm" %>
    ...
    <br /> <br />
            <div class="row">
                <div class="col-lg-12 text-left">
                    ...
                    <asp:Label ID="lblProMedicaidID" class="formLabelAuto" Text="" runat="server" />      
