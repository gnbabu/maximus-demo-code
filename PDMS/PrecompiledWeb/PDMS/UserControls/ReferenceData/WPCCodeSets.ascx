<%@ control language="C#" autoeventwireup="true" inherits="UserControls_ReferenceData_WPCCodeSets, App_Web_iq0r534d" %>
...
<div class="row">
    ...
    <div class="col-sm-9 text-left">
        <asp:DropDownList ID="ddlWPCCodeSet" runat="server" CssClass="formDropDown" OnInit="ddlWPCCodeSet_Init" > </asp:DropDownList>
    </div>     
</div> 
<div class="row">
