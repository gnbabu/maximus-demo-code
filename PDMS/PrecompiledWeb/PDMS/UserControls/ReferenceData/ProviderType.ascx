<%@ control language="C#" autoeventwireup="true" inherits="UserControls_ReferenceData_ProviderType, App_Web_iq0r534d" %>
...
<asp:Panel ID="pnlPageHeader" runat="server" CssClass="pageHeader">
        ...
        <h1 style="text-align: center;font-size: 25px;font-weight: bold;"><asp:Literal ID="pagelabel" runat="server" Text="Reference Data Management: Provider Type"></asp:Literal></h1>
