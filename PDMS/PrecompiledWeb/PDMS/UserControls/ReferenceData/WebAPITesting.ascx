<%@ control language="C#" autoeventwireup="true" inherits="UserControls_ReferenceData_WebAPITesting, App_Web_iq0r534d" %>
            ...
            <formtemplate>
                <div class="WhiteBox">
                    <div class="gridEditTable">
                        <div class="row">
                            <div class="col-sm-3 text-right">API Name : </div>
                            <div class="col-sm-9 text-left">
                                ...
                                <asp:RequiredFieldValidator ID="rfvAPIName" runat="server" ErrorMessage="* API Name is required"
                                    ControlToValidate="txtAPIName"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3 text-right">XML Description : </div>
                            <div class="col-sm-9 text-left">
                                ...
                                <asp:RequiredFieldValidator ID="rfvAPIDescp" runat="server" ErrorMessage="* XML Description is required"
                                    ControlToValidate="txtAPIDescp"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3 text-right">XML : </div>
                            <div class="col-sm-9 text-left">
                                ...
                                <asp:RequiredFieldValidator ID="rfvAPIXML" runat="server" ErrorMessage="* XML Value is required"
                                    ControlToValidate="txtAPIXML"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3 text-right">Enabled : </div>
                            <div class="col-sm-9 text-left">
