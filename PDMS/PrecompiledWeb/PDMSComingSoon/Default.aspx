<%@ page title="Home Page" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="_Default, App_Web_mzqzcsmt" enableEventValidation="false" stylesheettheme="Default" maintainScrollPositionOnPostBack="true" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:Panel ID="pnlHomePage" runat="server" CssClass="infoPanel">
        <br />
            <center><font size="14pt">Coming December 9th, 2013...</font></center>
        <br />
        ...
        <br /><br />
            ...
            <asp:HyperLink ID="lnkTennCare" runat="server" NavigateUrl="mailto:Provider.Registration@tn.gov" Text="Provider.Registration@tn.gov" Target="_blank" />  
